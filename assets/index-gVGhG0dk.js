(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&f(i)}).observe(document,{childList:!0,subtree:!0});function v(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function f(t){if(t.ep)return;t.ep=!0;const s=v(t);fetch(t.href,s)}})();class b{x;y;constructor(n,v){this.x=n??0,this.y=v??0}toArray(){return[this.x,this.y]}add(n){return new b(this.x+n.x,this.y+n.y)}addScalar(n){return new b(this.x+n,this.y+n)}subtract(n){return new b(this.x-n.x,this.y-n.y)}dot(n){return this.x*n.x+this.y*n.y}cross(n){return this.x*n.y-this.y*n.x}clone(){return new b(this.x,this.y)}truncate(){return new b(~~this.x,~~this.y)}scale(n){return new b(this.x*n,this.y*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this}}class m{x;y;z;static get Zero(){return new m(0,0,0)}static get One(){return new m(1,1,1)}static get Up(){return new m(0,1,0)}static get Forward(){return new m(0,0,1)}constructor(n,v,f){this.x=n??0,this.y=v??0,this.z=f??0}toArray(){return[this.x,this.y,this.z]}extend(n){return new T(this.x,this.y,this.z,n)}cross(n){return new m(this.y*n.z-this.z*n.y,this.z*n.x-this.x*n.z,this.x*n.y-this.y*n.x)}clone(){return new m(this.x,this.y,this.z)}truncate(){return new m(~~this.x,~~this.y,~~this.z)}scale(n){return new m(this.x*n,this.y*n,this.z*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this.z*=n,this}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalized(){const n=1/this.length();return new m(this.x*n,this.y*n,this.z*n)}normalize(){const n=1/this.length();return this.x*=n,this.y*=n,this.z*=n,this}translate(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}dot(n){return this.x*n.x+this.y*n.y+this.z*n.z}add(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}addInPlace(n){return this.x+=n.x,this.y+=n.y,this.z+=n.z,this}addScalar(n){return new m(this.x+n,this.y+n,this.z+n)}subtract(n){return new m(this.x-n.x,this.y-n.y,this.z-n.z)}multiply(n){return new m(this.x*n.x,this.y*n.y,this.z*n.z)}multiplyInPlace(n){return this.x*=n.x,this.y*=n.y,this.z*=n.z,this}set(n,v,f){this.x=n,this.y=v,this.z=f}reflect(n){return this.subtract(n.scale(2*this.dot(n)))}}class T{x;y;z;w;static get Zero(){return new T(0,0,0,0)}constructor(n,v,f,t){this.x=n??0,this.y=v??0,this.z=f??0,this.w=t??0}toArray(){return[this.x,this.y,this.z,this.w]}get xyz(){return new m(this.x,this.y,this.z)}truncate(){return new T(~~this.x,~~this.y,~~this.z,~~this.w)}divideByW(){return new m(this.x/this.w,this.y/this.w,this.z/this.w)}}class a{m;constructor(){this.m=new Float32Array(16)}static Identity(){const n=new a;return n.m[0]=1,n.m[5]=1,n.m[10]=1,n.m[15]=1,n}static Scale(n){const v=a.Identity();return v.m[0]=n.x,v.m[5]=n.y,v.m[10]=n.z,v}static RotateX(n){const v=a.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[5]=f,v.m[6]=t,v.m[9]=-t,v.m[10]=f,v}static RotateY(n){const v=a.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[2]=-t,v.m[8]=t,v.m[10]=f,v}static RotateZ(n){const v=a.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[1]=t,v.m[4]=-t,v.m[5]=f,v}static RotateYXZ(n){return a.RotateZ(n.z).multiply(a.RotateX(n.x)).multiply(a.RotateY(n.y))}static Translate(n){const v=a.Identity();return v.m[12]=n.x,v.m[13]=n.y,v.m[14]=n.z,v}static TRS(n,v,f){return a.Scale(f).multiply(a.RotateYXZ(v)).multiply(a.Translate(n))}static LookTo(n,v,f){const t=v.normalize(),s=f.cross(t).normalize(),i=t.cross(s).normalize(),e=a.Identity();return e.m[0]=s.x,e.m[1]=i.x,e.m[2]=t.x,e.m[4]=s.y,e.m[5]=i.y,e.m[6]=t.y,e.m[8]=s.z,e.m[9]=i.z,e.m[10]=t.z,e.m[12]=-s.dot(n),e.m[13]=-i.dot(n),e.m[14]=-t.dot(n),e}static LookAt(n,v,f){const t=v.subtract(n).normalize(),s=f.cross(t).normalize(),i=t.cross(s).normalize(),e=a.Identity();return e.m[0]=s.x,e.m[1]=i.x,e.m[2]=t.x,e.m[4]=s.y,e.m[5]=i.y,e.m[6]=t.y,e.m[8]=s.z,e.m[9]=i.z,e.m[10]=t.z,e.m[12]=-s.dot(n),e.m[13]=-i.dot(n),e.m[14]=-t.dot(n),e}static Ortho(n,v,f=.1,t=1e3){const s=a.Identity();return s.m[0]=1/(n*v),s.m[5]=1/n,s.m[10]=1/(t-f),s.m[14]=-f/(t-f),s}static Perspective(n,v,f=.1,t=1e3){const s=a.Identity(),i=n*(Math.PI/180),e=Math.tan(i/2);return s.m[0]=1/(v*e),s.m[5]=1/e,s.m[10]=t/(t-f),s.m[11]=1,s.m[14]=-f*(t/(t-f)),s.m[15]=0,s}toArray(){return this.m}multiplyVector4(n){const v=new T;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12],v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13],v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14],v.w=this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15],v}multiplyPoint(n){const v=1/(this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15]),f=new T;return f.x=(this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12])*v,f.y=(this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13])*v,f.z=(this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14])*v,f.w=v,f}multiplyDirection(n){const v=new m;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z,v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z,v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z,v}multiply(n){const v=new a;return v.m[0]=this.m[0]*n.m[0]+this.m[1]*n.m[4]+this.m[2]*n.m[8]+this.m[3]*n.m[12],v.m[1]=this.m[0]*n.m[1]+this.m[1]*n.m[5]+this.m[2]*n.m[9]+this.m[3]*n.m[13],v.m[2]=this.m[0]*n.m[2]+this.m[1]*n.m[6]+this.m[2]*n.m[10]+this.m[3]*n.m[14],v.m[3]=this.m[0]*n.m[3]+this.m[1]*n.m[7]+this.m[2]*n.m[11]+this.m[3]*n.m[15],v.m[4]=this.m[4]*n.m[0]+this.m[5]*n.m[4]+this.m[6]*n.m[8]+this.m[7]*n.m[12],v.m[5]=this.m[4]*n.m[1]+this.m[5]*n.m[5]+this.m[6]*n.m[9]+this.m[7]*n.m[13],v.m[6]=this.m[4]*n.m[2]+this.m[5]*n.m[6]+this.m[6]*n.m[10]+this.m[7]*n.m[14],v.m[7]=this.m[4]*n.m[3]+this.m[5]*n.m[7]+this.m[6]*n.m[11]+this.m[7]*n.m[15],v.m[8]=this.m[8]*n.m[0]+this.m[9]*n.m[4]+this.m[10]*n.m[8]+this.m[11]*n.m[12],v.m[9]=this.m[8]*n.m[1]+this.m[9]*n.m[5]+this.m[10]*n.m[9]+this.m[11]*n.m[13],v.m[10]=this.m[8]*n.m[2]+this.m[9]*n.m[6]+this.m[10]*n.m[10]+this.m[11]*n.m[14],v.m[11]=this.m[8]*n.m[3]+this.m[9]*n.m[7]+this.m[10]*n.m[11]+this.m[11]*n.m[15],v.m[12]=this.m[12]*n.m[0]+this.m[13]*n.m[4]+this.m[14]*n.m[8]+this.m[15]*n.m[12],v.m[13]=this.m[12]*n.m[1]+this.m[13]*n.m[5]+this.m[14]*n.m[9]+this.m[15]*n.m[13],v.m[14]=this.m[12]*n.m[2]+this.m[13]*n.m[6]+this.m[14]*n.m[10]+this.m[15]*n.m[14],v.m[15]=this.m[12]*n.m[3]+this.m[13]*n.m[7]+this.m[14]*n.m[11]+this.m[15]*n.m[15],v}transpose(){const n=new a;return n.m[0]=this.m[0],n.m[1]=this.m[4],n.m[2]=this.m[8],n.m[3]=this.m[12],n.m[4]=this.m[1],n.m[5]=this.m[5],n.m[6]=this.m[9],n.m[7]=this.m[13],n.m[8]=this.m[2],n.m[9]=this.m[6],n.m[10]=this.m[10],n.m[11]=this.m[14],n.m[12]=this.m[3],n.m[13]=this.m[7],n.m[14]=this.m[11],n.m[15]=this.m[15],n}invert(){let n=this.m,v=new a;v.m[0]=n[5]*n[10]*n[15]-n[5]*n[11]*n[14]-n[9]*n[6]*n[15]+n[9]*n[7]*n[14]+n[13]*n[6]*n[11]-n[13]*n[7]*n[10],v.m[4]=-n[4]*n[10]*n[15]+n[4]*n[11]*n[14]+n[8]*n[6]*n[15]-n[8]*n[7]*n[14]-n[12]*n[6]*n[11]+n[12]*n[7]*n[10],v.m[8]=n[4]*n[9]*n[15]-n[4]*n[11]*n[13]-n[8]*n[5]*n[15]+n[8]*n[7]*n[13]+n[12]*n[5]*n[11]-n[12]*n[7]*n[9],v.m[12]=-n[4]*n[9]*n[14]+n[4]*n[10]*n[13]+n[8]*n[5]*n[14]-n[8]*n[6]*n[13]-n[12]*n[5]*n[10]+n[12]*n[6]*n[9],v.m[1]=-n[1]*n[10]*n[15]+n[1]*n[11]*n[14]+n[9]*n[2]*n[15]-n[9]*n[3]*n[14]-n[13]*n[2]*n[11]+n[13]*n[3]*n[10],v.m[5]=n[0]*n[10]*n[15]-n[0]*n[11]*n[14]-n[8]*n[2]*n[15]+n[8]*n[3]*n[14]+n[12]*n[2]*n[11]-n[12]*n[3]*n[10],v.m[9]=-n[0]*n[9]*n[15]+n[0]*n[11]*n[13]+n[8]*n[1]*n[15]-n[8]*n[3]*n[13]-n[12]*n[1]*n[11]+n[12]*n[3]*n[9],v.m[13]=n[0]*n[9]*n[14]-n[0]*n[10]*n[13]-n[8]*n[1]*n[14]+n[8]*n[2]*n[13]+n[12]*n[1]*n[10]-n[12]*n[2]*n[9],v.m[2]=n[1]*n[6]*n[15]-n[1]*n[7]*n[14]-n[5]*n[2]*n[15]+n[5]*n[3]*n[14]+n[13]*n[2]*n[7]-n[13]*n[3]*n[6],v.m[6]=-n[0]*n[6]*n[15]+n[0]*n[7]*n[14]+n[4]*n[2]*n[15]-n[4]*n[3]*n[14]-n[12]*n[2]*n[7]+n[12]*n[3]*n[6],v.m[10]=n[0]*n[5]*n[15]-n[0]*n[7]*n[13]-n[4]*n[1]*n[15]+n[4]*n[3]*n[13]+n[12]*n[1]*n[7]-n[12]*n[3]*n[5],v.m[14]=-n[0]*n[5]*n[14]+n[0]*n[6]*n[13]+n[4]*n[1]*n[14]-n[4]*n[2]*n[13]-n[12]*n[1]*n[6]+n[12]*n[2]*n[5],v.m[3]=-n[1]*n[6]*n[11]+n[1]*n[7]*n[10]+n[5]*n[2]*n[11]-n[5]*n[3]*n[10]-n[9]*n[2]*n[7]+n[9]*n[3]*n[6],v.m[7]=n[0]*n[6]*n[11]-n[0]*n[7]*n[10]-n[4]*n[2]*n[11]+n[4]*n[3]*n[10]+n[8]*n[2]*n[7]-n[8]*n[3]*n[6],v.m[11]=-n[0]*n[5]*n[11]+n[0]*n[7]*n[9]+n[4]*n[1]*n[11]-n[4]*n[3]*n[9]-n[8]*n[1]*n[7]+n[8]*n[3]*n[5],v.m[15]=n[0]*n[5]*n[10]-n[0]*n[6]*n[9]-n[4]*n[1]*n[10]+n[4]*n[2]*n[9]+n[8]*n[1]*n[6]-n[8]*n[2]*n[5];let f=n[0]*v.m[0]+n[1]*v.m[4]+n[2]*v.m[8]+n[3]*v.m[12];if(f===0)return new a;const t=1/f;return v.m[0]*=t,v.m[1]*=t,v.m[2]*=t,v.m[3]*=t,v.m[4]*=t,v.m[5]*=t,v.m[6]*=t,v.m[7]*=t,v.m[8]*=t,v.m[9]*=t,v.m[10]*=t,v.m[11]*=t,v.m[12]*=t,v.m[13]*=t,v.m[14]*=t,v.m[15]*=t,v}print(){console.log(this.m[0].toFixed(2),this.m[4].toFixed(2),this.m[8].toFixed(2),this.m[12].toFixed(2)),console.log(this.m[1].toFixed(2),this.m[5].toFixed(2),this.m[9].toFixed(2),this.m[13].toFixed(2)),console.log(this.m[2].toFixed(2),this.m[6].toFixed(2),this.m[10].toFixed(2),this.m[14].toFixed(2)),console.log(this.m[3].toFixed(2),this.m[7].toFixed(2),this.m[11].toFixed(2),this.m[15].toFixed(2))}}const g0=new m(1,1,1),Q=(h,n,v)=>{if(h.z<-1||n.z<-1||h.z>1||n.z>1||h.x<-1&&n.x<-1||h.x>1&&n.x>1||h.y<-1&&n.y<-1||h.y>1&&n.y>1)return;h=v.viewportTransform(h),n=v.viewportTransform(n);let f=h.truncate(),t=n.truncate();const s=Math.abs(t.x-f.x),i=Math.abs(t.y-f.y),e=f.x<t.x?1:-1,c=f.y<t.y?1:-1;let u=s-i;for(;f.x>=0&&f.x<v.width&&f.y>=0&&f.y<v.height&&v.setPixel(f.x,f.y,g0),!(f.x===t.x&&f.y===t.y);){const d=2*u;d>-i&&(u-=i,f.x+=e),d<s&&(u+=s,f.y+=c)}},j=(h,n,v)=>(v.x-h.x)*(n.y-h.y)-(v.y-h.y)*(n.x-h.x),x=new T,w={u:0,v:0,w:0},X={u:0,v:0,w:0},e0=(h,n,v,f)=>{const t=v.viewportTransform(h[0]),s=v.viewportTransform(h[1]),i=v.viewportTransform(h[2]),e=1/j(i,s,t);if(e<=0||t.z<0||s.z<0||i.z<0||t.z>1||s.z>1||i.z>1||t.x<0&&s.x<0&&i.x<0||t.x>v.width&&s.x>v.width&&i.x>v.width||t.y<0&&s.y<0&&i.y<0||t.y>v.height&&s.y>v.height&&i.y>v.height)return;let c=~~Math.max(0,Math.min(t.x,s.x,i.x)),u=~~Math.max(0,Math.min(t.y,s.y,i.y)),d=~~Math.min(v.width,Math.max(t.x,s.x,i.x)),M=~~Math.min(v.height,Math.max(t.y,s.y,i.y));const l=new T(c,u);let p=j(i,s,l)*e,g=j(t,i,l)*e,D=j(s,t,l)*e;const I=new b(s.y-i.y,i.x-s.x).scaleInPlace(e),r=new b(i.y-t.y,t.x-i.x).scaleInPlace(e),o=new b(t.y-s.y,s.x-t.x).scaleInPlace(e);for(x.y=u;x.y<=M;x.y++){for(w.u=p,w.v=g,w.w=D,x.x=c;x.x<=d;x.x++){if(w.u>=0&&w.v>=0&&w.w>=0){x.z=t.z*w.u+s.z*w.v+i.z*w.w;const z=x.x+x.y*v.width;if(x.z<f.data[z]){f.data[z]=x.z,x.w=1/(t.w*w.u+s.w*w.v+i.w*w.w),X.u=w.u*x.w*t.w,X.v=w.v*x.w*s.w,X.w=w.w*x.w*i.w,n.bc=X,n.fragPos=x;const y=n.fragment();y&&v.setPixel(x.x,x.y,y)}}w.u+=I.x,w.v+=r.x,w.w+=o.x}p+=I.y,g+=r.y,D+=o.y}};class m0{data;width;height;constructor(n,v){this.data=new Float32Array(n*v),this.width=n,this.height=v}clear(n){this.data.fill(n)}}class K{data;width;height;constructor(n,v,f){this.data=n,this.width=v,this.height=f}static Load=async(n,v=!1)=>{const f=new Image;f.src=n,await f.decode();const s=new OffscreenCanvas(f.width,f.height).getContext("2d");if(!s)throw new Error("Could not get texture context");s.drawImage(f,0,0);const i=s.getImageData(0,0,f.width,f.height),e=[];for(let c=0;c<i.data.length;c+=4)if(v){const u=new m(i.data[c]/255*2-1,i.data[c+1]/255*2-1,i.data[c+2]/255*2-1).normalize();e.push(u)}else e.push(new m(i.data[c]/255,i.data[c+1]/255,i.data[c+2]/255));return new K(e,f.width,f.height)}}class z0{width;height;totalPixels;data;constructor(n){this.width=n.width,this.height=n.height,this.totalPixels=this.width*this.height,this.data=n.data}setPixel=(n,v,f)=>{const t=(n+v*this.width)*4;this.data[t+0]=f.x*255,this.data[t+1]=f.y*255,this.data[t+2]=f.z*255};clear=()=>{this.data.fill(0);for(let n=3;n<this.totalPixels*4;n+=4)this.data[n]=255};viewportTransform=n=>{const v=(n.x+1)*(this.width*.5),f=(-n.y+1)*(this.height*.5);return new T(v,f,n.z,n.w)}}const G=h=>{let v=(Math.abs(h.y)<.999?m.Up:m.Forward).cross(h);return v.lengthSq()<1e-8&&(v=new m(1,0,0).cross(h)),v.lengthSq()<1e-8&&(v=new m(1,0,0)),v.normalize()},c0=(h,n=!1)=>{const v=[];let f=[];const t=[],s=[],i=[],e=[],c=[],u=[],d=[],M=[],l=[],p=[],g=h.split(`
`);for(let r=0;r<g.length;r++){const o=g[r].trim().split(/\s+/),z=o.length===5;o[0]=="v"?c.push(new m(+o[1],+o[2],+o[3])):o[0]=="vt"?u.push(new b(+o[1],+o[2])):o[0]=="vn"?d.push(new m(+o[1],+o[2],+o[3])):o[0]=="f"&&(z?(M.push(+o[1].split("/")[0]-1,+o[2].split("/")[0]-1,+o[3].split("/")[0]-1),M.push(+o[1].split("/")[0]-1,+o[3].split("/")[0]-1,+o[4].split("/")[0]-1),l.push(+o[1].split("/")[1]-1,+o[2].split("/")[1]-1,+o[3].split("/")[1]-1),l.push(+o[1].split("/")[1]-1,+o[3].split("/")[1]-1,+o[4].split("/")[1]-1),p.push(+o[1].split("/")[2]-1,+o[2].split("/")[2]-1,+o[3].split("/")[2]-1),p.push(+o[1].split("/")[2]-1,+o[3].split("/")[2]-1,+o[4].split("/")[2]-1)):(M.push(+o[1].split("/")[0]-1,+o[2].split("/")[0]-1,+o[3].split("/")[0]-1),l.push(+o[1].split("/")[1]-1,+o[2].split("/")[1]-1,+o[3].split("/")[1]-1),p.push(+o[1].split("/")[2]-1,+o[2].split("/")[2]-1,+o[3].split("/")[2]-1)))}const D=new m(0,0,0),I=new m(0,0,0);for(let r=0;r<M.length;r++){const o=c[M[r]],z=d[p[r]],y=u[l[r]];v.push(o),z&&f.push(z),y&&t.push(y),o.x>D.x&&(D.x=o.x),o.y>D.y&&(D.y=o.y),o.z>D.z&&(D.z=o.z),o.x<I.x&&(I.x=o.x),o.y<I.y&&(I.y=o.y),o.z<I.z&&(I.z=o.z)}for(let r=0;r<v.length;r+=3){const o=v[r+1].subtract(v[r]),z=v[r+2].subtract(v[r]),y=o.cross(z).normalize();s.push(y,y,y)}if(n){const r=D.subtract(I),o=2/Math.max(r.x,r.y,r.z),z=D.add(I).scale(.5);for(let y=0;y<v.length;y++)v[y]=v[y].subtract(z).scale(o)}f.length||(f=s);for(let r=0;r<f.length;r++)f[r]=f[r].normalized();if(t.length===v.length)for(let r=0;r<v.length;r+=3){const o=v[r],z=v[r+1],y=v[r+2],t0=t[r],w0=t[r+1],p0=t[r+2],f0=z.subtract(o),s0=y.subtract(o),Y=w0.subtract(t0),q=p0.subtract(t0),i0=Y.x*q.y-q.x*Y.y;let W,$;if(Math.abs(i0)>1e-6){const S=1/i0;W=f0.scale(q.y).subtract(s0.scale(Y.y)).scale(S),$=s0.scale(Y.x).subtract(f0.scale(q.x)).scale(S)}else{const S=f[r];W=G(S),$=S.cross(W).normalize()}for(let S=0;S<3;S++){const C=f[r+S];let V=W.subtract(C.scale(C.dot(W)));V.lengthSq()<1e-8?V=G(C):V=V.normalize();let F=$.subtract(C.scale(C.dot($)));F.lengthSq()<1e-8?F=C.cross(V).normalize():F=F.normalize(),C.cross(V).dot(F)<0&&(F=F.scale(-1)),i.push(V),e.push(F)}}else for(let r=0;r<v.length;r++){const o=f[r],z=G(o),y=o.cross(z).normalize();i.push(z),e.push(y)}return{vertices:v,normals:f,faceNormals:s,uvs:t,tangents:i,bitangents:e}};class E{vertexId=0;nthVert=0;bc={u:0,v:0,w:0};fragPos=new T;v2f=(n,v)=>{n[this.nthVert]=v};varying=()=>Array(3);interpolate=n=>{const v=this.bc.u,f=this.bc.v,t=this.bc.w;return n[0]*v+n[1]*f+n[2]*t};interpolateVec2=n=>{const v=this.bc.u,f=this.bc.v,t=this.bc.w,s=n[0].x*v+n[1].x*f+n[2].x*t,i=n[0].y*v+n[1].y*f+n[2].y*t;return new b(s,i)};interpolateVec3=n=>{const v=this.bc.u,f=this.bc.v,t=this.bc.w,s=n[0].x*v+n[1].x*f+n[2].x*t,i=n[0].y*v+n[1].y*f+n[2].y*t,e=n[0].z*v+n[1].z*f+n[2].z*t;return new m(s,i,e)};interpolateVec4=n=>{const v=this.bc.u,f=this.bc.v,t=this.bc.w,s=n[0].x*v+n[1].x*f+n[2].x*t,i=n[0].y*v+n[1].y*f+n[2].y*t,e=n[0].z*v+n[1].z*f+n[2].z*t,c=n[0].w*v+n[1].w*f+n[2].w*t;return new T(s,i,e,c)};interpolateVec2To=(n,v)=>{const f=this.bc.u,t=this.bc.v,s=this.bc.w;return v.x=n[0].x*f+n[1].x*t+n[2].x*s,v.y=n[0].y*f+n[1].y*t+n[2].y*s,v};interpolateVec3To=(n,v)=>{const f=this.bc.u,t=this.bc.v,s=this.bc.w;return v.x=n[0].x*f+n[1].x*t+n[2].x*s,v.y=n[0].y*f+n[1].y*t+n[2].y*s,v.z=n[0].z*f+n[1].z*t+n[2].z*s,v};interpolateVec4To=(n,v)=>{const f=this.bc.u,t=this.bc.v,s=this.bc.w;return v.x=n[0].x*f+n[1].x*t+n[2].x*s,v.y=n[0].y*f+n[1].y*t+n[2].y*s,v.z=n[0].z*f+n[1].z*t+n[2].z*s,v.w=n[0].w*f+n[1].w*t+n[2].w*s,v};sample=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s].clone()};sampleTo=(n,v,f)=>{const t=~~(v.x*n.width),s=~~((1-v.y)*n.height),i=t+s*n.width,e=n.data[i];return f.x=e.x,f.y=e.y,f.z=e.z,f};sampleDepth=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s]}}const P0=.25,b0=16,D0=.1;class I0 extends E{uniforms;vNormal=this.varying();vWorldPos=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),t=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let s=Math.pow(Math.max(n.dot(t),0),b0);s*=P0;const e=Math.max(-n.dot(this.uniforms.lightDir),0)+s+D0;return this.uniforms.lightCol.scale(e*.8)}}const T0=.25,M0=16,S0=.1;class F0 extends E{uniforms;vNormal=this.varying();vWorldPos=this.varying();vUV=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.v2f(this.vUV,n.uvs[v]),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),f=this.interpolateVec2(this.vUV),t=this.sample(this.uniforms.texture,f),i=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let e=Math.pow(Math.max(n.dot(i),0),M0);e*=T0;const c=Math.max(-n.dot(this.uniforms.lightDir),0),u=this.uniforms.lightCol.scale(c+e+S0);return t.multiplyInPlace(u)}}const L0=.25,C0=16,V0=.1;class R0 extends E{uniforms;lighting=0;vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.normalMat.multiplyDirection(n.faceNormals[v]).normalize(),t=this.uniforms.mvp.multiplyPoint(n.vertices[v]),i=this.uniforms.camPos.subtract(t.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let e=Math.pow(Math.max(f.dot(i),0),C0);e*=L0;const c=Math.max(-f.dot(this.uniforms.lightDir),0);return this.lighting=c+e+V0,this.lighting*=.8,this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>this.uniforms.lightCol.scale(this.lighting)}class U0 extends E{uniforms;vertex=()=>this.uniforms.lightSpaceMat.multiplyPoint(this.uniforms.model.vertices[this.vertexId]);fragment=()=>{}}const N0=1e-4,W0=.25,A0=16,O0=.1;class B0 extends E{uniforms;vUV=this.varying();vLightSpacePos=this.varying();vLightDirTangent=this.varying();vViewDirTangent=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=n.normals[v],t=n.tangents[v],s=n.bitangents[v],i=n.vertices[v],e=new m(t.dot(this.uniforms.mLightDir),s.dot(this.uniforms.mLightDir),f.dot(this.uniforms.mLightDir)),c=this.uniforms.mCamPos.subtract(i).normalize(),u=new m(t.dot(c),s.dot(c),f.dot(c)),d=this.uniforms.lightSpaceMat.multiplyPoint(i);return d.x=d.x*.5+.5,d.y=d.y*.5+.5,this.v2f(this.vUV,n.uvs[v]),this.v2f(this.vLightSpacePos,d),this.v2f(this.vLightDirTangent,e),this.v2f(this.vViewDirTangent,u),this.uniforms.mvp.multiplyPoint(i)};fragment=()=>{const n=this.interpolateVec2(this.vUV),v=this.interpolateVec4(this.vLightSpacePos),f=this.interpolateVec3(this.vLightDirTangent).normalize(),t=this.interpolateVec3(this.vViewDirTangent).normalize(),s=this.sampleDepth(this.uniforms.shadowMap,v),i=v.z-N0>s?0:1,e=this.sample(this.uniforms.texture,n),c=this.sample(this.uniforms.normalTexture,n),u=t.subtract(f).normalize();let d=Math.pow(Math.max(c.dot(u),0),A0);d*=W0;const l=(Math.max(-c.dot(f),0)+d)*i+O0,p=this.uniforms.lightCol.scale(l);return e.multiplyInPlace(p)}}const E0=`v -0.000581696 -0.734665 -0.623267
...
# 2492 faces
`,Y0="/js-renderer/assets/head_diffuse-Cy3ctF3i.png",q0="/js-renderer/assets/head_normal_t-2qWK4TOR.png",P=document.getElementById("canvas"),$0=document.getElementById("fps"),a0=document.getElementById("tris"),l0=document.getElementById("orthoCb"),R=document.getElementById("shadingDd"),J=document.getElementById("fileInput"),u0=P.getContext("2d");if(!u0)throw new Error("Could not get canvas context");P.width=800;P.height=600;const _=P.width/P.height,d0=new ImageData(P.width,P.height),N=new z0(d0),o0=new m0(P.width,P.height),n0=new m0(P.width,P.height),Z=new m(0,-1,1).normalize(),j0=new m(1,1,1),k=new m(0,0,-2.5);let O=1.5,L=c0(E0,!0),v0=await K.Load(Y0),y0=await K.Load(q0,!0);a0.innerText=(L.vertices.length/3).toFixed(0);let H=new m(0,0,0),B=new m(0,-Math.PI/2,0),X0=new m(1,1,1);const h0={normalMapped:new B0,textured:new F0,smooth:new I0,flat:new R0};let U;const A=new U0,Z0=h=>{B.y-=h/5},k0=()=>{N.clear(),o0.clear(1e3),n0.clear(1e3);const h=a.TRS(H,B,X0),n=h.invert(),v=h.invert().transpose(),f=a.LookTo(Z.scale(-5),Z,m.Up),t=a.Ortho(O,_),s=h.multiply(f.multiply(t)),i=n.multiplyDirection(Z).normalize(),e=n.multiplyPoint(k).xyz,c=a.LookTo(k,m.Forward,m.Up),u=l0.checked?a.Ortho(O,_):a.Perspective(60,_),d=h.multiply(c).multiply(u);R.value!=="wireframe"&&(U=h0[R.value.split("-")[0]]),!(v0.data.length&&L.uvs.length)&&(R.value.includes("textured")||R.value.includes("normalMapped"))&&(R.value="smooth",U=h0.smooth),A.uniforms={model:L,lightSpaceMat:s},U.uniforms={model:L,modelMat:h,mvp:d,normalMat:v,lightDir:Z,mLightDir:i,lightCol:j0,camPos:k,mCamPos:e,texture:v0,normalTexture:y0,lightSpaceMat:s,shadowMap:n0};const l=[];if(R.value.includes("shadows"))for(let p=0;p<L.vertices.length;p+=3){for(let g=0;g<3;g++)A.vertexId=p+g,A.nthVert=g,l[g]=A.vertex();e0(l,A,N,n0)}for(let p=0;p<L.vertices.length;p+=3){for(let g=0;g<3;g++)U.vertexId=p+g,U.nthVert=g,l[g]=U.vertex();if(R.value==="wireframe"){Q(l[0],l[1],N),Q(l[1],l[2],N),Q(l[2],l[0],N);continue}e0(l,U,N,o0)}u0.putImageData(d0,0,0)};let r0=0;const x0=()=>{const h=performance.now(),n=(h-r0)/1e3;r0=h,Z0(n),k0();const v=performance.now()-h;$0.innerText=v.toFixed(0),requestAnimationFrame(x0)};P.onmousemove=h=>{h.buttons===1?(B.y-=h.movementX/250,B.x+=h.movementY/250):(h.buttons===2||h.buttons===4)&&(H.x+=h.movementX/250,H.y-=h.movementY/250)};P.onwheel=h=>{h.preventDefault(),l0.checked?(O+=h.deltaY/100,O=Math.max(.01,O)):k.z-=h.deltaY/100};P.oncontextmenu=h=>h.preventDefault();J.onchange=async()=>{const h=J.files&&J.files[0];if(!h)return;const n=await h.text();L=c0(n,!0),v0.data=[],y0.data=[],a0.innerText=(L.vertices.length/3).toFixed(0),B.set(0,-Math.PI/2,0),H.set(0,0,0)};x0();
