(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&f(o)}).observe(document,{childList:!0,subtree:!0});function v(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function f(t){if(t.ep)return;t.ep=!0;const s=v(t);fetch(t.href,s)}})();class z{x;y;constructor(n,v){this.x=n??0,this.y=v??0}toArray(){return[this.x,this.y]}add(n){return new z(this.x+n.x,this.y+n.y)}addScalar(n){return new z(this.x+n,this.y+n)}subtract(n){return new z(this.x-n.x,this.y-n.y)}dot(n){return this.x*n.x+this.y*n.y}cross(n){return this.x*n.y-this.y*n.x}clone(){return new z(this.x,this.y)}truncate(){return new z(~~this.x,~~this.y)}scale(n){return new z(this.x*n,this.y*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this}}class m{x;y;z;static get Zero(){return new m(0,0,0)}static get One(){return new m(1,1,1)}static get Up(){return new m(0,1,0)}static get Forward(){return new m(0,0,1)}constructor(n,v,f){this.x=n??0,this.y=v??0,this.z=f??0}toArray(){return[this.x,this.y,this.z]}extend(n){return new T(this.x,this.y,this.z,n)}cross(n){return new m(this.y*n.z-this.z*n.y,this.z*n.x-this.x*n.z,this.x*n.y-this.y*n.x)}clone(){return new m(this.x,this.y,this.z)}truncate(){return new m(~~this.x,~~this.y,~~this.z)}scale(n){return new m(this.x*n,this.y*n,this.z*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this.z*=n,this}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalized(){const n=1/this.length();return new m(this.x*n,this.y*n,this.z*n)}normalize(){const n=1/this.length();return this.x*=n,this.y*=n,this.z*=n,this}translate(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}dot(n){return this.x*n.x+this.y*n.y+this.z*n.z}add(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}addInPlace(n){return this.x+=n.x,this.y+=n.y,this.z+=n.z,this}addScalar(n){return new m(this.x+n,this.y+n,this.z+n)}subtract(n){return new m(this.x-n.x,this.y-n.y,this.z-n.z)}multiply(n){return new m(this.x*n.x,this.y*n.y,this.z*n.z)}multiplyInPlace(n){return this.x*=n.x,this.y*=n.y,this.z*=n.z,this}set(n,v,f){this.x=n,this.y=v,this.z=f}reflect(n){return this.subtract(n.scale(2*this.dot(n)))}}class T{x;y;z;w;static get Zero(){return new T(0,0,0,0)}constructor(n,v,f,t){this.x=n??0,this.y=v??0,this.z=f??0,this.w=t??0}toArray(){return[this.x,this.y,this.z,this.w]}get xyz(){return new m(this.x,this.y,this.z)}truncate(){return new T(~~this.x,~~this.y,~~this.z,~~this.w)}divideByW(){return new m(this.x/this.w,this.y/this.w,this.z/this.w)}}class l{m;constructor(){this.m=new Float32Array(16)}static Identity(){const n=new l;return n.m[0]=1,n.m[5]=1,n.m[10]=1,n.m[15]=1,n}static Scale(n){const v=l.Identity();return v.m[0]=n.x,v.m[5]=n.y,v.m[10]=n.z,v}static RotateX(n){const v=l.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[5]=f,v.m[6]=t,v.m[9]=-t,v.m[10]=f,v}static RotateY(n){const v=l.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[2]=-t,v.m[8]=t,v.m[10]=f,v}static RotateZ(n){const v=l.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[1]=t,v.m[4]=-t,v.m[5]=f,v}static RotateYXZ(n){return l.RotateZ(n.z).multiply(l.RotateX(n.x)).multiply(l.RotateY(n.y))}static Translate(n){const v=l.Identity();return v.m[12]=n.x,v.m[13]=n.y,v.m[14]=n.z,v}static TRS(n,v,f){return l.Scale(f).multiply(l.RotateYXZ(v)).multiply(l.Translate(n))}static LookTo(n,v,f){const t=v.normalize(),s=f.cross(t).normalize(),o=t.cross(s).normalize(),r=l.Identity();return r.m[0]=s.x,r.m[1]=o.x,r.m[2]=t.x,r.m[4]=s.y,r.m[5]=o.y,r.m[6]=t.y,r.m[8]=s.z,r.m[9]=o.z,r.m[10]=t.z,r.m[12]=-s.dot(n),r.m[13]=-o.dot(n),r.m[14]=-t.dot(n),r}static LookAt(n,v,f){const t=v.subtract(n).normalize(),s=f.cross(t).normalize(),o=t.cross(s).normalize(),r=l.Identity();return r.m[0]=s.x,r.m[1]=o.x,r.m[2]=t.x,r.m[4]=s.y,r.m[5]=o.y,r.m[6]=t.y,r.m[8]=s.z,r.m[9]=o.z,r.m[10]=t.z,r.m[12]=-s.dot(n),r.m[13]=-o.dot(n),r.m[14]=-t.dot(n),r}static Ortho(n,v,f=.1,t=1e3){const s=l.Identity();return s.m[0]=1/(n*v),s.m[5]=1/n,s.m[10]=1/(t-f),s.m[14]=-f/(t-f),s}static Perspective(n,v,f=.1,t=1e3){const s=l.Identity(),o=n*(Math.PI/180),r=Math.tan(o/2);return s.m[0]=1/(v*r),s.m[5]=1/r,s.m[10]=t/(t-f),s.m[11]=1,s.m[14]=-f*(t/(t-f)),s.m[15]=0,s}toArray(){return this.m}multiplyVector4(n){const v=new T;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12],v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13],v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14],v.w=this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15],v}multiplyPoint(n){const v=1/(this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15]),f=new T;return f.x=(this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12])*v,f.y=(this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13])*v,f.z=(this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14])*v,f.w=v,f}multiplyDirection(n){const v=new m;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z,v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z,v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z,v}multiply(n){const v=new l;return v.m[0]=this.m[0]*n.m[0]+this.m[1]*n.m[4]+this.m[2]*n.m[8]+this.m[3]*n.m[12],v.m[1]=this.m[0]*n.m[1]+this.m[1]*n.m[5]+this.m[2]*n.m[9]+this.m[3]*n.m[13],v.m[2]=this.m[0]*n.m[2]+this.m[1]*n.m[6]+this.m[2]*n.m[10]+this.m[3]*n.m[14],v.m[3]=this.m[0]*n.m[3]+this.m[1]*n.m[7]+this.m[2]*n.m[11]+this.m[3]*n.m[15],v.m[4]=this.m[4]*n.m[0]+this.m[5]*n.m[4]+this.m[6]*n.m[8]+this.m[7]*n.m[12],v.m[5]=this.m[4]*n.m[1]+this.m[5]*n.m[5]+this.m[6]*n.m[9]+this.m[7]*n.m[13],v.m[6]=this.m[4]*n.m[2]+this.m[5]*n.m[6]+this.m[6]*n.m[10]+this.m[7]*n.m[14],v.m[7]=this.m[4]*n.m[3]+this.m[5]*n.m[7]+this.m[6]*n.m[11]+this.m[7]*n.m[15],v.m[8]=this.m[8]*n.m[0]+this.m[9]*n.m[4]+this.m[10]*n.m[8]+this.m[11]*n.m[12],v.m[9]=this.m[8]*n.m[1]+this.m[9]*n.m[5]+this.m[10]*n.m[9]+this.m[11]*n.m[13],v.m[10]=this.m[8]*n.m[2]+this.m[9]*n.m[6]+this.m[10]*n.m[10]+this.m[11]*n.m[14],v.m[11]=this.m[8]*n.m[3]+this.m[9]*n.m[7]+this.m[10]*n.m[11]+this.m[11]*n.m[15],v.m[12]=this.m[12]*n.m[0]+this.m[13]*n.m[4]+this.m[14]*n.m[8]+this.m[15]*n.m[12],v.m[13]=this.m[12]*n.m[1]+this.m[13]*n.m[5]+this.m[14]*n.m[9]+this.m[15]*n.m[13],v.m[14]=this.m[12]*n.m[2]+this.m[13]*n.m[6]+this.m[14]*n.m[10]+this.m[15]*n.m[14],v.m[15]=this.m[12]*n.m[3]+this.m[13]*n.m[7]+this.m[14]*n.m[11]+this.m[15]*n.m[15],v}transpose(){const n=new l;return n.m[0]=this.m[0],n.m[1]=this.m[4],n.m[2]=this.m[8],n.m[3]=this.m[12],n.m[4]=this.m[1],n.m[5]=this.m[5],n.m[6]=this.m[9],n.m[7]=this.m[13],n.m[8]=this.m[2],n.m[9]=this.m[6],n.m[10]=this.m[10],n.m[11]=this.m[14],n.m[12]=this.m[3],n.m[13]=this.m[7],n.m[14]=this.m[11],n.m[15]=this.m[15],n}invert(){let n=this.m,v=new l;v.m[0]=n[5]*n[10]*n[15]-n[5]*n[11]*n[14]-n[9]*n[6]*n[15]+n[9]*n[7]*n[14]+n[13]*n[6]*n[11]-n[13]*n[7]*n[10],v.m[4]=-n[4]*n[10]*n[15]+n[4]*n[11]*n[14]+n[8]*n[6]*n[15]-n[8]*n[7]*n[14]-n[12]*n[6]*n[11]+n[12]*n[7]*n[10],v.m[8]=n[4]*n[9]*n[15]-n[4]*n[11]*n[13]-n[8]*n[5]*n[15]+n[8]*n[7]*n[13]+n[12]*n[5]*n[11]-n[12]*n[7]*n[9],v.m[12]=-n[4]*n[9]*n[14]+n[4]*n[10]*n[13]+n[8]*n[5]*n[14]-n[8]*n[6]*n[13]-n[12]*n[5]*n[10]+n[12]*n[6]*n[9],v.m[1]=-n[1]*n[10]*n[15]+n[1]*n[11]*n[14]+n[9]*n[2]*n[15]-n[9]*n[3]*n[14]-n[13]*n[2]*n[11]+n[13]*n[3]*n[10],v.m[5]=n[0]*n[10]*n[15]-n[0]*n[11]*n[14]-n[8]*n[2]*n[15]+n[8]*n[3]*n[14]+n[12]*n[2]*n[11]-n[12]*n[3]*n[10],v.m[9]=-n[0]*n[9]*n[15]+n[0]*n[11]*n[13]+n[8]*n[1]*n[15]-n[8]*n[3]*n[13]-n[12]*n[1]*n[11]+n[12]*n[3]*n[9],v.m[13]=n[0]*n[9]*n[14]-n[0]*n[10]*n[13]-n[8]*n[1]*n[14]+n[8]*n[2]*n[13]+n[12]*n[1]*n[10]-n[12]*n[2]*n[9],v.m[2]=n[1]*n[6]*n[15]-n[1]*n[7]*n[14]-n[5]*n[2]*n[15]+n[5]*n[3]*n[14]+n[13]*n[2]*n[7]-n[13]*n[3]*n[6],v.m[6]=-n[0]*n[6]*n[15]+n[0]*n[7]*n[14]+n[4]*n[2]*n[15]-n[4]*n[3]*n[14]-n[12]*n[2]*n[7]+n[12]*n[3]*n[6],v.m[10]=n[0]*n[5]*n[15]-n[0]*n[7]*n[13]-n[4]*n[1]*n[15]+n[4]*n[3]*n[13]+n[12]*n[1]*n[7]-n[12]*n[3]*n[5],v.m[14]=-n[0]*n[5]*n[14]+n[0]*n[6]*n[13]+n[4]*n[1]*n[14]-n[4]*n[2]*n[13]-n[12]*n[1]*n[6]+n[12]*n[2]*n[5],v.m[3]=-n[1]*n[6]*n[11]+n[1]*n[7]*n[10]+n[5]*n[2]*n[11]-n[5]*n[3]*n[10]-n[9]*n[2]*n[7]+n[9]*n[3]*n[6],v.m[7]=n[0]*n[6]*n[11]-n[0]*n[7]*n[10]-n[4]*n[2]*n[11]+n[4]*n[3]*n[10]+n[8]*n[2]*n[7]-n[8]*n[3]*n[6],v.m[11]=-n[0]*n[5]*n[11]+n[0]*n[7]*n[9]+n[4]*n[1]*n[11]-n[4]*n[3]*n[9]-n[8]*n[1]*n[7]+n[8]*n[3]*n[5],v.m[15]=n[0]*n[5]*n[10]-n[0]*n[6]*n[9]-n[4]*n[1]*n[10]+n[4]*n[2]*n[9]+n[8]*n[1]*n[6]-n[8]*n[2]*n[5];let f=n[0]*v.m[0]+n[1]*v.m[4]+n[2]*v.m[8]+n[3]*v.m[12];if(f===0)return new l;const t=1/f;return v.m[0]*=t,v.m[1]*=t,v.m[2]*=t,v.m[3]*=t,v.m[4]*=t,v.m[5]*=t,v.m[6]*=t,v.m[7]*=t,v.m[8]*=t,v.m[9]*=t,v.m[10]*=t,v.m[11]*=t,v.m[12]*=t,v.m[13]*=t,v.m[14]*=t,v.m[15]*=t,v}print(){console.log(this.m[0].toFixed(2),this.m[4].toFixed(2),this.m[8].toFixed(2),this.m[12].toFixed(2)),console.log(this.m[1].toFixed(2),this.m[5].toFixed(2),this.m[9].toFixed(2),this.m[13].toFixed(2)),console.log(this.m[2].toFixed(2),this.m[6].toFixed(2),this.m[10].toFixed(2),this.m[14].toFixed(2)),console.log(this.m[3].toFixed(2),this.m[7].toFixed(2),this.m[11].toFixed(2),this.m[15].toFixed(2))}}const P0=new m(1,1,1),k=(e,n,v)=>{if(e.z<-1||n.z<-1||e.z>1||n.z>1||e.x<-1&&n.x<-1||e.x>1&&n.x>1||e.y<-1&&n.y<-1||e.y>1&&n.y>1)return;e=v.viewportTransform(e),n=v.viewportTransform(n);let f=e.truncate(),t=n.truncate();const s=Math.abs(t.x-f.x),o=Math.abs(t.y-f.y),r=f.x<t.x?1:-1,a=f.y<t.y?1:-1;let c=s-o;for(;f.x>=0&&f.x<v.width&&f.y>=0&&f.y<v.height&&v.setPixel(f.x,f.y,P0),!(f.x===t.x&&f.y===t.y);){const u=2*c;u>-o&&(c-=o,f.x+=r),u<s&&(c+=s,f.y+=a)}},$=(e,n,v)=>(v.x-e.x)*(n.y-e.y)-(v.y-e.y)*(n.x-e.x),y=new T,x={u:0,v:0,w:0},q={u:0,v:0,w:0},S0=(e,n,v,f)=>{const t=v.viewportTransform(e[0]),s=v.viewportTransform(e[1]),o=v.viewportTransform(e[2]),r=1/$(o,s,t);if(r<=0||t.z<0||s.z<0||o.z<0||t.z>1||s.z>1||o.z>1||t.x<0&&s.x<0&&o.x<0||t.x>v.width&&s.x>v.width&&o.x>v.width||t.y<0&&s.y<0&&o.y<0||t.y>v.height&&s.y>v.height&&o.y>v.height)return;let a=~~Math.max(0,Math.min(t.x,s.x,o.x)),c=~~Math.max(0,Math.min(t.y,s.y,o.y)),u=~~Math.min(v.width,Math.max(t.x,s.x,o.x)),P=~~Math.min(v.height,Math.max(t.y,s.y,o.y));const g=new T(a,c);let F=$(o,s,g)*r,N=$(t,o,g)*r,S=$(s,t,g)*r;const I=new z(s.y-o.y,o.x-s.x).scaleInPlace(r),h=new z(o.y-t.y,t.x-o.x).scaleInPlace(r),i=new z(t.y-s.y,s.x-t.x).scaleInPlace(r);for(y.y=c;y.y<=P;y.y++){for(x.u=F,x.v=N,x.w=S,y.x=a;y.x<=u;y.x++){if(x.u>=0&&x.v>=0&&x.w>=0){y.z=t.z*x.u+s.z*x.v+o.z*x.w;const p=y.x+y.y*v.width;if(y.z<f.data[p]){f.data[p]=y.z,y.w=1/(t.w*x.u+s.w*x.v+o.w*x.w),q.u=x.u*y.w*t.w,q.v=x.v*y.w*s.w,q.w=x.w*y.w*o.w,n.bc=q,n.fragPos=y;const d=n.fragment();d&&v.setPixel(y.x,y.y,d)}}x.u+=I.x,x.v+=h.x,x.w+=i.x}F+=I.y,N+=h.y,S+=i.y}};class l0{data;width;height;constructor(n,v){this.data=new Float32Array(n*v),this.width=n,this.height=v}clear(n){this.data.fill(n)}}class H{data;width;height;constructor(n,v,f){this.data=n,this.width=v,this.height=f}static Load=async(n,v=!1)=>{const f=new Image;f.src=n,await f.decode();const s=new OffscreenCanvas(f.width,f.height).getContext("2d");if(!s)throw new Error("Could not get texture context");s.drawImage(f,0,0);const o=s.getImageData(0,0,f.width,f.height),r=[];for(let a=0;a<o.data.length;a+=4)if(v){const c=new m(o.data[a]/255*2-1,o.data[a+1]/255*2-1,o.data[a+2]/255*2-1).normalize();r.push(c)}else r.push(new m(o.data[a]/255,o.data[a+1]/255,o.data[a+2]/255));return new H(r,f.width,f.height)}}class I0{width;height;totalPixels;data;constructor(n){this.width=n.width,this.height=n.height,this.totalPixels=this.width*this.height,this.data=n.data}setPixel=(n,v,f)=>{const t=(n+v*this.width)*4;this.data[t+0]=f.x*255,this.data[t+1]=f.y*255,this.data[t+2]=f.z*255};clear=()=>{this.data.fill(0);for(let n=3;n<this.totalPixels*4;n+=4)this.data[n]=255};viewportTransform=n=>{const v=(n.x+1)*(this.width*.5),f=(-n.y+1)*(this.height*.5);return new T(v,f,n.z,n.w)}}const K=e=>{let v=(Math.abs(e.y)<.999?m.Up:m.Forward).cross(e);return v.lengthSq()<1e-8&&(v=new m(1,0,0).cross(e)),v.lengthSq()<1e-8&&(v=new m(1,0,0)),v.normalize()},c0=(e,n=!1)=>{const v=[];let f=[];const t=[],s=[],o=[],r=[],a=[],c=[],u=[],P=[],g=[],F=[],N=e.split(`
`);for(let h=0;h<N.length;h++){const i=N[h].trim().split(/\s+/),p=i.length===5;i[0]=="v"?a.push(new m(+i[1],+i[2],+i[3])):i[0]=="vt"?c.push(new z(+i[1],+i[2])):i[0]=="vn"?u.push(new m(+i[1],+i[2],+i[3])):i[0]=="f"&&(p?(P.push(+i[1].split("/")[0]-1,+i[2].split("/")[0]-1,+i[3].split("/")[0]-1),P.push(+i[1].split("/")[0]-1,+i[3].split("/")[0]-1,+i[4].split("/")[0]-1),g.push(+i[1].split("/")[1]-1,+i[2].split("/")[1]-1,+i[3].split("/")[1]-1),g.push(+i[1].split("/")[1]-1,+i[3].split("/")[1]-1,+i[4].split("/")[1]-1),F.push(+i[1].split("/")[2]-1,+i[2].split("/")[2]-1,+i[3].split("/")[2]-1),F.push(+i[1].split("/")[2]-1,+i[3].split("/")[2]-1,+i[4].split("/")[2]-1)):(P.push(+i[1].split("/")[0]-1,+i[2].split("/")[0]-1,+i[3].split("/")[0]-1),g.push(+i[1].split("/")[1]-1,+i[2].split("/")[1]-1,+i[3].split("/")[1]-1),F.push(+i[1].split("/")[2]-1,+i[2].split("/")[2]-1,+i[3].split("/")[2]-1)))}const S=new m(0,0,0),I=new m(0,0,0);for(let h=0;h<P.length;h++){const i=a[P[h]],p=u[F[h]],d=c[g[h]];v.push(i),p&&f.push(p),d&&t.push(d),i.x>S.x&&(S.x=i.x),i.y>S.y&&(S.y=i.y),i.z>S.z&&(S.z=i.z),i.x<I.x&&(I.x=i.x),i.y<I.y&&(I.y=i.y),i.z<I.z&&(I.z=i.z)}for(let h=0;h<v.length;h+=3){const i=v[h+1].subtract(v[h]),p=v[h+2].subtract(v[h]),d=i.cross(p).normalize();s.push(d,d,d)}if(n){const h=S.subtract(I),i=2/Math.max(h.x,h.y,h.z),p=S.add(I).scale(.5);for(let d=0;d<v.length;d++)v[d]=v[d].subtract(p).scale(i)}f.length||(f=s);for(let h=0;h<f.length;h++)f[h]=f[h].normalized();if(t.length===v.length)for(let h=0;h<v.length;h+=3){const i=v[h],p=v[h+1],d=v[h+2],n0=t[h],g0=t[h+1],z0=t[h+2],v0=p.subtract(i),t0=d.subtract(i),U=g0.subtract(n0),Y=z0.subtract(n0),f0=U.x*Y.y-Y.x*U.y;let R,B;if(Math.abs(f0)>1e-6){const M=1/f0;R=v0.scale(Y.y).subtract(t0.scale(U.y)).scale(M),B=t0.scale(U.x).subtract(v0.scale(Y.x)).scale(M)}else{const M=f[h];R=K(M),B=M.cross(R).normalize()}for(let M=0;M<3;M++){const V=f[h+M];let C=R.subtract(V.scale(V.dot(R)));C.lengthSq()<1e-8?C=K(V):C=C.normalize();let D=B.subtract(V.scale(V.dot(B)));D.lengthSq()<1e-8?D=V.cross(C).normalize():D=D.normalize(),V.cross(C).dot(D)<0&&(D=D.scale(-1)),o.push(C),r.push(D)}}else for(let h=0;h<v.length;h++){const i=f[h],p=K(i),d=i.cross(p).normalize();o.push(p),r.push(d)}return{vertices:v,normals:f,faceNormals:s,uvs:t,tangents:o,bitangents:r}};class W{vertexId=0;nthVert=0;bc={u:0,v:0,w:0};fragPos=new T;v2f=(n,v)=>{n[this.nthVert]=v};varying=()=>Array(3);interpolate=n=>n[0]*this.bc.u+n[1]*this.bc.v+n[2]*this.bc.w;interpolateVec2=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]);return new z(v,f)};interpolateVec3=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]);return new m(v,f,t)};interpolateVec4=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]),s=this.interpolate([n[0].w,n[1].w,n[2].w]);return new T(v,f,t,s)};toTexelCoord=(n,v,f)=>{const t=Math.max(0,Math.min(v-1,~~(n.x*v))),s=Math.max(0,Math.min(f-1,~~((1-n.y)*f)));return{x:t,y:s}};sample=(n,v)=>{const f=this.toTexelCoord(v,n.width,n.height),t=f.x+f.y*n.width;return n.data[t].clone()};sampleDepth=(n,v)=>{const f=this.toTexelCoord(v,n.width,n.height),t=f.x+f.y*n.width;return n.data[t]}}const T0=.25,M0=16,D0=.1,b0=.8;class F0 extends W{uniforms;vNormal=this.varying();vWorldPos=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),t=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let s=Math.pow(Math.max(n.dot(t),0),M0);s*=T0;const r=Math.max(-n.dot(this.uniforms.lightDir),0)+s+D0;return this.uniforms.lightCol.scale(r*b0)}}const V0=.25,C0=16,L0=.1;class N0 extends W{uniforms;vNormal=this.varying();vWorldPos=this.varying();vUV=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.v2f(this.vUV,n.uvs[v]),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),f=this.interpolateVec2(this.vUV),t=this.sample(this.uniforms.texture,f),o=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let r=Math.pow(Math.max(n.dot(o),0),C0);r*=V0;const a=Math.max(-n.dot(this.uniforms.lightDir),0),c=this.uniforms.lightCol.scale(a+r+L0);return t.multiplyInPlace(c)}}const R0=.25,A0=16,O0=.1,E0=.8;class W0 extends W{uniforms;lighting=0;vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.normalMat.multiplyDirection(n.faceNormals[v]).normalize(),t=this.uniforms.mvp.multiplyPoint(n.vertices[v]),o=this.uniforms.camPos.subtract(t.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let r=Math.pow(Math.max(f.dot(o),0),A0);r*=R0;const a=Math.max(-f.dot(this.uniforms.lightDir),0);return this.lighting=(a+r+O0)*E0,this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>this.uniforms.lightCol.scale(this.lighting)}class U0 extends W{uniforms;vertex=()=>this.uniforms.lightSpaceMat.multiplyPoint(this.uniforms.model.vertices[this.vertexId]);fragment=()=>{}}const Y0=1e-4,B0=.25,$0=16,q0=.1;class X0 extends W{uniforms;vUV=this.varying();vLightSpacePos=this.varying();vLightDirTangent=this.varying();vViewDirTangent=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=n.normals[v],t=n.tangents[v],s=n.bitangents[v],o=n.vertices[v],r=new m(t.dot(this.uniforms.mLightDir),s.dot(this.uniforms.mLightDir),f.dot(this.uniforms.mLightDir)),a=this.uniforms.mCamPos.subtract(o).normalize(),c=new m(t.dot(a),s.dot(a),f.dot(a)),u=this.uniforms.lightSpaceMat.multiplyPoint(o);return u.x=u.x*.5+.5,u.y=u.y*.5+.5,this.v2f(this.vUV,n.uvs[v]),this.v2f(this.vLightSpacePos,u),this.v2f(this.vLightDirTangent,r),this.v2f(this.vViewDirTangent,c),this.uniforms.mvp.multiplyPoint(o)};fragment=()=>{const n=this.interpolateVec2(this.vUV),v=this.interpolateVec4(this.vLightSpacePos),f=this.interpolateVec3(this.vLightDirTangent).normalize(),t=this.interpolateVec3(this.vViewDirTangent).normalize(),s=this.sampleDepth(this.uniforms.shadowMap,v),o=v.z-Y0>s?0:1,r=this.sample(this.uniforms.texture,n),a=this.sample(this.uniforms.normalTexture,n),c=t.subtract(f).normalize();let u=Math.pow(Math.max(a.dot(c),0),$0);u*=B0;const P=Math.max(-a.dot(f),0),g=this.uniforms.lightCol.scale((P+u)*o+q0);return r.multiplyInPlace(g)}}const j0=(e,n)=>{let v=e;switch(!n&&(v.includes("textured")||v.includes("normalMapped"))&&(v="smooth"),v){case"normalMapped-shadows":return{material:"normalMapped",wireframe:!1,useShadows:!0,normalizedValue:v};case"normalMapped":return{material:"normalMapped",wireframe:!1,useShadows:!1,normalizedValue:v};case"textured":return{material:"textured",wireframe:!1,useShadows:!1,normalizedValue:v};case"smooth":return{material:"smooth",wireframe:!1,useShadows:!1,normalizedValue:v};case"flat":return{material:"flat",wireframe:!1,useShadows:!1,normalizedValue:v};default:return{material:"smooth",wireframe:!0,useShadows:!1,normalizedValue:"wireframe"}}},Z0=`v -0.000581696 -0.734665 -0.623267
...
# 2492 faces
`,H0="/js-renderer/assets/head_diffuse-Cy3ctF3i.png",k0="/js-renderer/assets/head_normal_t-2qWK4TOR.png",K0=800,G0=600,Q0=5,s0=250,e0=250,i0=100,w=document.getElementById("canvas"),J0=document.getElementById("fps"),_0=document.getElementById("tris"),u0=document.getElementById("orthoCb"),G=document.getElementById("shadingDd"),o0=document.getElementById("fileInput"),d0=w.getContext("2d");if(!d0)throw new Error("Could not get canvas context");w.width=K0;w.height=G0;const Q=w.width/w.height,y0=new ImageData(w.width,w.height),A=new I0(y0),r0=new l0(w.width,w.height),J=new l0(w.width,w.height),X=new m(0,-1,1).normalize(),n1=new m(1,1,1),j=new m(0,0,-2.5);let O=1.5,L=c0(Z0,!0),_=await H.Load(H0),x0=await H.Load(k0,!0),Z=new m(0,0,0),E=new m(0,-Math.PI/2,0),v1=new m(1,1,1);const t1={normalMapped:new X0,textured:new N0,smooth:new F0,flat:new W0},h0=new U0,b=[],p0=()=>{_0.innerText=(L.vertices.length/3).toFixed(0)},f1=()=>{E.set(0,-Math.PI/2,0),Z.set(0,0,0)},s1=()=>{const e=j0(G.value,_.data.length>0&&L.uvs.length>0);return e.normalizedValue!==G.value&&(G.value=e.normalizedValue),{shaderKey:e.material,wireframe:e.wireframe,useShadows:e.useShadows}},m0=(e,n,v=!1)=>{for(let f=0;f<L.vertices.length;f+=3){for(let t=0;t<3;t++)e.vertexId=f+t,e.nthVert=t,b[t]=e.vertex();if(v){k(b[0],b[1],A),k(b[1],b[2],A),k(b[2],b[0],A);continue}S0(b,e,A,n)}},e1=e=>{E.y-=e/Q0},i1=()=>{A.clear(),r0.clear(1e3),J.clear(1e3);const e=s1(),n=l.TRS(Z,E,v1),v=n.invert(),f=n.invert().transpose(),t=l.LookTo(X.scale(-5),X,m.Up),s=l.Ortho(O,Q),o=n.multiply(t.multiply(s)),r=v.multiplyDirection(X).normalize(),a=v.multiplyPoint(j).xyz,c=l.LookTo(j,m.Forward,m.Up),u=u0.checked?l.Ortho(O,Q):l.Perspective(60,Q),P=n.multiply(c).multiply(u),g=t1[e.shaderKey];h0.uniforms={model:L,lightSpaceMat:o},g.uniforms={model:L,modelMat:n,mvp:P,normalMat:f,lightDir:X,mLightDir:r,lightCol:n1,camPos:j,mCamPos:a,texture:_,normalTexture:x0,lightSpaceMat:o,shadowMap:J},e.useShadows&&m0(h0,J),m0(g,r0,e.wireframe),d0.putImageData(y0,0,0)};let a0=0;const w0=()=>{const e=performance.now(),n=(e-a0)/1e3;a0=e,e1(n),i1();const v=performance.now()-e;J0.innerText=v.toFixed(0),requestAnimationFrame(w0)};w.onmousemove=e=>{e.buttons===1?(E.y-=e.movementX/s0,E.x+=e.movementY/s0):(e.buttons===2||e.buttons===4)&&(Z.x+=e.movementX/e0,Z.y-=e.movementY/e0)};w.onwheel=e=>{e.preventDefault(),u0.checked?(O+=e.deltaY/i0,O=Math.max(.01,O)):j.z-=e.deltaY/i0};w.oncontextmenu=e=>e.preventDefault();o0.onchange=async()=>{const e=o0.files?.[0];if(!e)return;const n=await e.text();L=c0(n,!0),_.data=[],x0.data=[],p0(),f1()};p0();w0();
