(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const e of s.addedNodes)e.tagName==="LINK"&&e.rel==="modulepreload"&&f(e)}).observe(document,{childList:!0,subtree:!0});function v(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function f(t){if(t.ep)return;t.ep=!0;const s=v(t);fetch(t.href,s)}})();class D{x;y;constructor(n,v){this.x=n??0,this.y=v??0}toArray(){return[this.x,this.y]}add(n){return new D(this.x+n.x,this.y+n.y)}addScalar(n){return new D(this.x+n,this.y+n)}subtract(n){return new D(this.x-n.x,this.y-n.y)}dot(n){return this.x*n.x+this.y*n.y}cross(n){return this.x*n.y-this.y*n.x}clone(){return new D(this.x,this.y)}truncate(){return new D(~~this.x,~~this.y)}scale(n){return new D(this.x*n,this.y*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this}}class m{x;y;z;static get Zero(){return new m(0,0,0)}static get One(){return new m(1,1,1)}static get Up(){return new m(0,1,0)}static get Forward(){return new m(0,0,1)}constructor(n,v,f){this.x=n??0,this.y=v??0,this.z=f??0}toArray(){return[this.x,this.y,this.z]}extend(n){return new M(this.x,this.y,this.z,n)}cross(n){return new m(this.y*n.z-this.z*n.y,this.z*n.x-this.x*n.z,this.x*n.y-this.y*n.x)}clone(){return new m(this.x,this.y,this.z)}truncate(){return new m(~~this.x,~~this.y,~~this.z)}scale(n){return new m(this.x*n,this.y*n,this.z*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this.z*=n,this}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalized(){const n=1/this.length();return new m(this.x*n,this.y*n,this.z*n)}normalize(){const n=1/this.length();return this.x*=n,this.y*=n,this.z*=n,this}translate(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}dot(n){return this.x*n.x+this.y*n.y+this.z*n.z}add(n){return new m(this.x+n.x,this.y+n.y,this.z+n.z)}addInPlace(n){return this.x+=n.x,this.y+=n.y,this.z+=n.z,this}addScalar(n){return new m(this.x+n,this.y+n,this.z+n)}subtract(n){return new m(this.x-n.x,this.y-n.y,this.z-n.z)}multiply(n){return new m(this.x*n.x,this.y*n.y,this.z*n.z)}multiplyInPlace(n){return this.x*=n.x,this.y*=n.y,this.z*=n.z,this}set(n,v,f){this.x=n,this.y=v,this.z=f}reflect(n){return this.subtract(n.scale(2*this.dot(n)))}}class M{x;y;z;w;static get Zero(){return new M(0,0,0,0)}constructor(n,v,f,t){this.x=n??0,this.y=v??0,this.z=f??0,this.w=t??0}toArray(){return[this.x,this.y,this.z,this.w]}get xyz(){return new m(this.x,this.y,this.z)}truncate(){return new M(~~this.x,~~this.y,~~this.z,~~this.w)}divideByW(){return new m(this.x/this.w,this.y/this.w,this.z/this.w)}}class c{m;constructor(){this.m=new Float32Array(16)}static Identity(){const n=new c;return n.m[0]=1,n.m[5]=1,n.m[10]=1,n.m[15]=1,n}static Scale(n){const v=c.Identity();return v.m[0]=n.x,v.m[5]=n.y,v.m[10]=n.z,v}static RotateX(n){const v=c.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[5]=f,v.m[6]=t,v.m[9]=-t,v.m[10]=f,v}static RotateY(n){const v=c.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[2]=-t,v.m[8]=t,v.m[10]=f,v}static RotateZ(n){const v=c.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[1]=t,v.m[4]=-t,v.m[5]=f,v}static RotateYXZ(n){return c.RotateZ(n.z).multiply(c.RotateX(n.x)).multiply(c.RotateY(n.y))}static Translate(n){const v=c.Identity();return v.m[12]=n.x,v.m[13]=n.y,v.m[14]=n.z,v}static TRS(n,v,f){return c.Scale(f).multiply(c.RotateYXZ(v)).multiply(c.Translate(n))}static LookTo(n,v,f){const t=v.normalize(),s=f.cross(t).normalize(),e=t.cross(s).normalize(),h=c.Identity();return h.m[0]=s.x,h.m[1]=e.x,h.m[2]=t.x,h.m[4]=s.y,h.m[5]=e.y,h.m[6]=t.y,h.m[8]=s.z,h.m[9]=e.z,h.m[10]=t.z,h.m[12]=-s.dot(n),h.m[13]=-e.dot(n),h.m[14]=-t.dot(n),h}static LookAt(n,v,f){const t=v.subtract(n).normalize(),s=f.cross(t).normalize(),e=t.cross(s).normalize(),h=c.Identity();return h.m[0]=s.x,h.m[1]=e.x,h.m[2]=t.x,h.m[4]=s.y,h.m[5]=e.y,h.m[6]=t.y,h.m[8]=s.z,h.m[9]=e.z,h.m[10]=t.z,h.m[12]=-s.dot(n),h.m[13]=-e.dot(n),h.m[14]=-t.dot(n),h}static Ortho(n,v,f=.1,t=1e3){const s=c.Identity();return s.m[0]=1/(n*v),s.m[5]=1/n,s.m[10]=1/(t-f),s.m[14]=-f/(t-f),s}static Perspective(n,v,f=.1,t=1e3){const s=c.Identity(),e=n*(Math.PI/180),h=Math.tan(e/2);return s.m[0]=1/(v*h),s.m[5]=1/h,s.m[10]=t/(t-f),s.m[11]=1,s.m[14]=-f*(t/(t-f)),s.m[15]=0,s}toArray(){return this.m}multiplyVector4(n){const v=new M;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12],v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13],v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14],v.w=this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15],v}multiplyPoint(n){const v=1/(this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15]),f=new M;return f.x=(this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12])*v,f.y=(this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13])*v,f.z=(this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14])*v,f.w=v,f}multiplyDirection(n){const v=new m;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z,v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z,v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z,v}multiply(n){const v=new c;return v.m[0]=this.m[0]*n.m[0]+this.m[1]*n.m[4]+this.m[2]*n.m[8]+this.m[3]*n.m[12],v.m[1]=this.m[0]*n.m[1]+this.m[1]*n.m[5]+this.m[2]*n.m[9]+this.m[3]*n.m[13],v.m[2]=this.m[0]*n.m[2]+this.m[1]*n.m[6]+this.m[2]*n.m[10]+this.m[3]*n.m[14],v.m[3]=this.m[0]*n.m[3]+this.m[1]*n.m[7]+this.m[2]*n.m[11]+this.m[3]*n.m[15],v.m[4]=this.m[4]*n.m[0]+this.m[5]*n.m[4]+this.m[6]*n.m[8]+this.m[7]*n.m[12],v.m[5]=this.m[4]*n.m[1]+this.m[5]*n.m[5]+this.m[6]*n.m[9]+this.m[7]*n.m[13],v.m[6]=this.m[4]*n.m[2]+this.m[5]*n.m[6]+this.m[6]*n.m[10]+this.m[7]*n.m[14],v.m[7]=this.m[4]*n.m[3]+this.m[5]*n.m[7]+this.m[6]*n.m[11]+this.m[7]*n.m[15],v.m[8]=this.m[8]*n.m[0]+this.m[9]*n.m[4]+this.m[10]*n.m[8]+this.m[11]*n.m[12],v.m[9]=this.m[8]*n.m[1]+this.m[9]*n.m[5]+this.m[10]*n.m[9]+this.m[11]*n.m[13],v.m[10]=this.m[8]*n.m[2]+this.m[9]*n.m[6]+this.m[10]*n.m[10]+this.m[11]*n.m[14],v.m[11]=this.m[8]*n.m[3]+this.m[9]*n.m[7]+this.m[10]*n.m[11]+this.m[11]*n.m[15],v.m[12]=this.m[12]*n.m[0]+this.m[13]*n.m[4]+this.m[14]*n.m[8]+this.m[15]*n.m[12],v.m[13]=this.m[12]*n.m[1]+this.m[13]*n.m[5]+this.m[14]*n.m[9]+this.m[15]*n.m[13],v.m[14]=this.m[12]*n.m[2]+this.m[13]*n.m[6]+this.m[14]*n.m[10]+this.m[15]*n.m[14],v.m[15]=this.m[12]*n.m[3]+this.m[13]*n.m[7]+this.m[14]*n.m[11]+this.m[15]*n.m[15],v}transpose(){const n=new c;return n.m[0]=this.m[0],n.m[1]=this.m[4],n.m[2]=this.m[8],n.m[3]=this.m[12],n.m[4]=this.m[1],n.m[5]=this.m[5],n.m[6]=this.m[9],n.m[7]=this.m[13],n.m[8]=this.m[2],n.m[9]=this.m[6],n.m[10]=this.m[10],n.m[11]=this.m[14],n.m[12]=this.m[3],n.m[13]=this.m[7],n.m[14]=this.m[11],n.m[15]=this.m[15],n}invert(){let n=this.m,v=new c;v.m[0]=n[5]*n[10]*n[15]-n[5]*n[11]*n[14]-n[9]*n[6]*n[15]+n[9]*n[7]*n[14]+n[13]*n[6]*n[11]-n[13]*n[7]*n[10],v.m[4]=-n[4]*n[10]*n[15]+n[4]*n[11]*n[14]+n[8]*n[6]*n[15]-n[8]*n[7]*n[14]-n[12]*n[6]*n[11]+n[12]*n[7]*n[10],v.m[8]=n[4]*n[9]*n[15]-n[4]*n[11]*n[13]-n[8]*n[5]*n[15]+n[8]*n[7]*n[13]+n[12]*n[5]*n[11]-n[12]*n[7]*n[9],v.m[12]=-n[4]*n[9]*n[14]+n[4]*n[10]*n[13]+n[8]*n[5]*n[14]-n[8]*n[6]*n[13]-n[12]*n[5]*n[10]+n[12]*n[6]*n[9],v.m[1]=-n[1]*n[10]*n[15]+n[1]*n[11]*n[14]+n[9]*n[2]*n[15]-n[9]*n[3]*n[14]-n[13]*n[2]*n[11]+n[13]*n[3]*n[10],v.m[5]=n[0]*n[10]*n[15]-n[0]*n[11]*n[14]-n[8]*n[2]*n[15]+n[8]*n[3]*n[14]+n[12]*n[2]*n[11]-n[12]*n[3]*n[10],v.m[9]=-n[0]*n[9]*n[15]+n[0]*n[11]*n[13]+n[8]*n[1]*n[15]-n[8]*n[3]*n[13]-n[12]*n[1]*n[11]+n[12]*n[3]*n[9],v.m[13]=n[0]*n[9]*n[14]-n[0]*n[10]*n[13]-n[8]*n[1]*n[14]+n[8]*n[2]*n[13]+n[12]*n[1]*n[10]-n[12]*n[2]*n[9],v.m[2]=n[1]*n[6]*n[15]-n[1]*n[7]*n[14]-n[5]*n[2]*n[15]+n[5]*n[3]*n[14]+n[13]*n[2]*n[7]-n[13]*n[3]*n[6],v.m[6]=-n[0]*n[6]*n[15]+n[0]*n[7]*n[14]+n[4]*n[2]*n[15]-n[4]*n[3]*n[14]-n[12]*n[2]*n[7]+n[12]*n[3]*n[6],v.m[10]=n[0]*n[5]*n[15]-n[0]*n[7]*n[13]-n[4]*n[1]*n[15]+n[4]*n[3]*n[13]+n[12]*n[1]*n[7]-n[12]*n[3]*n[5],v.m[14]=-n[0]*n[5]*n[14]+n[0]*n[6]*n[13]+n[4]*n[1]*n[14]-n[4]*n[2]*n[13]-n[12]*n[1]*n[6]+n[12]*n[2]*n[5],v.m[3]=-n[1]*n[6]*n[11]+n[1]*n[7]*n[10]+n[5]*n[2]*n[11]-n[5]*n[3]*n[10]-n[9]*n[2]*n[7]+n[9]*n[3]*n[6],v.m[7]=n[0]*n[6]*n[11]-n[0]*n[7]*n[10]-n[4]*n[2]*n[11]+n[4]*n[3]*n[10]+n[8]*n[2]*n[7]-n[8]*n[3]*n[6],v.m[11]=-n[0]*n[5]*n[11]+n[0]*n[7]*n[9]+n[4]*n[1]*n[11]-n[4]*n[3]*n[9]-n[8]*n[1]*n[7]+n[8]*n[3]*n[5],v.m[15]=n[0]*n[5]*n[10]-n[0]*n[6]*n[9]-n[4]*n[1]*n[10]+n[4]*n[2]*n[9]+n[8]*n[1]*n[6]-n[8]*n[2]*n[5];let f=n[0]*v.m[0]+n[1]*v.m[4]+n[2]*v.m[8]+n[3]*v.m[12];if(f===0)return new c;const t=1/f;return v.m[0]*=t,v.m[1]*=t,v.m[2]*=t,v.m[3]*=t,v.m[4]*=t,v.m[5]*=t,v.m[6]*=t,v.m[7]*=t,v.m[8]*=t,v.m[9]*=t,v.m[10]*=t,v.m[11]*=t,v.m[12]*=t,v.m[13]*=t,v.m[14]*=t,v.m[15]*=t,v}print(){console.log(this.m[0].toFixed(2),this.m[4].toFixed(2),this.m[8].toFixed(2),this.m[12].toFixed(2)),console.log(this.m[1].toFixed(2),this.m[5].toFixed(2),this.m[9].toFixed(2),this.m[13].toFixed(2)),console.log(this.m[2].toFixed(2),this.m[6].toFixed(2),this.m[10].toFixed(2),this.m[14].toFixed(2)),console.log(this.m[3].toFixed(2),this.m[7].toFixed(2),this.m[11].toFixed(2),this.m[15].toFixed(2))}}const g0=new m(1,1,1),Q=(o,n,v)=>{if(o.z<-1||n.z<-1||o.z>1||n.z>1||o.x<-1&&n.x<-1||o.x>1&&n.x>1||o.y<-1&&n.y<-1||o.y>1&&n.y>1)return;o=v.viewportTransform(o),n=v.viewportTransform(n);let f=o.truncate(),t=n.truncate();const s=Math.abs(t.x-f.x),e=Math.abs(t.y-f.y),h=f.x<t.x?1:-1,a=f.y<t.y?1:-1;let u=s-e;for(;f.x>=0&&f.x<v.width&&f.y>=0&&f.y<v.height&&v.setPixel(f.x,f.y,g0),!(f.x===t.x&&f.y===t.y);){const d=2*u;d>-e&&(u-=e,f.x+=h),d<s&&(u+=s,f.y+=a)}},j=(o,n,v)=>(v.x-o.x)*(n.y-o.y)-(v.y-o.y)*(n.x-o.x),x=new M,p={u:0,v:0,w:0},X={u:0,v:0,w:0},e0=(o,n,v,f)=>{const t=v.viewportTransform(o[0]),s=v.viewportTransform(o[1]),e=v.viewportTransform(o[2]),h=1/j(e,s,t);if(h<=0||t.z<0||s.z<0||e.z<0||t.z>1||s.z>1||e.z>1||t.x<0&&s.x<0&&e.x<0||t.x>v.width&&s.x>v.width&&e.x>v.width||t.y<0&&s.y<0&&e.y<0||t.y>v.height&&s.y>v.height&&e.y>v.height)return;let a=~~Math.max(0,Math.min(t.x,s.x,e.x)),u=~~Math.max(0,Math.min(t.y,s.y,e.y)),d=~~Math.min(v.width,Math.max(t.x,s.x,e.x)),T=~~Math.min(v.height,Math.max(t.y,s.y,e.y));const l=new M(a,u);let w=j(e,s,l)*h,g=j(t,e,l)*h,I=j(s,t,l)*h;const b=new D(s.y-e.y,e.x-s.x).scaleInPlace(h),r=new D(e.y-t.y,t.x-e.x).scaleInPlace(h),i=new D(t.y-s.y,s.x-t.x).scaleInPlace(h);for(x.y=u;x.y<=T;x.y++){for(p.u=w,p.v=g,p.w=I,x.x=a;x.x<=d;x.x++){if(p.u>=0&&p.v>=0&&p.w>=0){x.z=t.z*p.u+s.z*p.v+e.z*p.w;const z=x.x+x.y*v.width;if(x.z<f.data[z]){f.data[z]=x.z,x.w=1/(t.w*p.u+s.w*p.v+e.w*p.w),X.u=p.u*x.w*t.w,X.v=p.v*x.w*s.w,X.w=p.w*x.w*e.w,n.bc=X,n.fragPos=x;const y=n.fragment();y&&v.setPixel(x.x,x.y,y)}}p.u+=b.x,p.v+=r.x,p.w+=i.x}w+=b.y,g+=r.y,I+=i.y}};class m0{data;width;height;constructor(n,v){this.data=new Float32Array(n*v),this.width=n,this.height=v}clear(n){this.data.fill(n)}}class K{data;width;height;constructor(n,v,f){this.data=n,this.width=v,this.height=f}static Load=async(n,v=!1)=>{const f=new Image;f.src=n,await f.decode();const s=new OffscreenCanvas(f.width,f.height).getContext("2d");if(!s)throw new Error("Could not get texture context");s.drawImage(f,0,0);const e=s.getImageData(0,0,f.width,f.height),h=[];for(let a=0;a<e.data.length;a+=4)if(v){const u=new m(e.data[a]/255*2-1,e.data[a+1]/255*2-1,e.data[a+2]/255*2-1).normalize();h.push(u)}else h.push(new m(e.data[a]/255,e.data[a+1]/255,e.data[a+2]/255));return new K(h,f.width,f.height)}}class z0{width;height;totalPixels;data;constructor(n){this.width=n.width,this.height=n.height,this.totalPixels=this.width*this.height,this.data=n.data}setPixel=(n,v,f)=>{const t=(n+v*this.width)*4;this.data[t+0]=f.x*255,this.data[t+1]=f.y*255,this.data[t+2]=f.z*255};clear=()=>{this.data.fill(0);for(let n=3;n<this.totalPixels*4;n+=4)this.data[n]=255};viewportTransform=n=>{const v=(n.x+1)*(this.width*.5),f=(-n.y+1)*(this.height*.5);return new M(v,f,n.z,n.w)}}const G=o=>{let v=(Math.abs(o.y)<.999?m.Up:m.Forward).cross(o);return v.lengthSq()<1e-8&&(v=new m(1,0,0).cross(o)),v.lengthSq()<1e-8&&(v=new m(1,0,0)),v.normalize()},a0=(o,n=!1)=>{const v=[];let f=[];const t=[],s=[],e=[],h=[],a=[],u=[],d=[],T=[],l=[],w=[],g=o.split(`
`);for(let r=0;r<g.length;r++){const i=g[r].trim().split(/\s+/),z=i.length===5;i[0]=="v"?a.push(new m(+i[1],+i[2],+i[3])):i[0]=="vt"?u.push(new D(+i[1],+i[2])):i[0]=="vn"?d.push(new m(+i[1],+i[2],+i[3])):i[0]=="f"&&(z?(T.push(+i[1].split("/")[0]-1,+i[2].split("/")[0]-1,+i[3].split("/")[0]-1),T.push(+i[1].split("/")[0]-1,+i[3].split("/")[0]-1,+i[4].split("/")[0]-1),l.push(+i[1].split("/")[1]-1,+i[2].split("/")[1]-1,+i[3].split("/")[1]-1),l.push(+i[1].split("/")[1]-1,+i[3].split("/")[1]-1,+i[4].split("/")[1]-1),w.push(+i[1].split("/")[2]-1,+i[2].split("/")[2]-1,+i[3].split("/")[2]-1),w.push(+i[1].split("/")[2]-1,+i[3].split("/")[2]-1,+i[4].split("/")[2]-1)):(T.push(+i[1].split("/")[0]-1,+i[2].split("/")[0]-1,+i[3].split("/")[0]-1),l.push(+i[1].split("/")[1]-1,+i[2].split("/")[1]-1,+i[3].split("/")[1]-1),w.push(+i[1].split("/")[2]-1,+i[2].split("/")[2]-1,+i[3].split("/")[2]-1)))}const I=new m(0,0,0),b=new m(0,0,0);for(let r=0;r<T.length;r++){const i=a[T[r]],z=d[w[r]],y=u[l[r]];v.push(i),z&&f.push(z),y&&t.push(y),i.x>I.x&&(I.x=i.x),i.y>I.y&&(I.y=i.y),i.z>I.z&&(I.z=i.z),i.x<b.x&&(b.x=i.x),i.y<b.y&&(b.y=i.y),i.z<b.z&&(b.z=i.z)}for(let r=0;r<v.length;r+=3){const i=v[r+1].subtract(v[r]),z=v[r+2].subtract(v[r]),y=i.cross(z).normalize();s.push(y,y,y)}if(n){const r=I.subtract(b),i=2/Math.max(r.x,r.y,r.z),z=I.add(b).scale(.5);for(let y=0;y<v.length;y++)v[y]=v[y].subtract(z).scale(i)}f.length||(f=s);for(let r=0;r<f.length;r++)f[r]=f[r].normalized();if(t.length===v.length)for(let r=0;r<v.length;r+=3){const i=v[r],z=v[r+1],y=v[r+2],t0=t[r],p0=t[r+1],w0=t[r+2],f0=z.subtract(i),s0=y.subtract(i),Y=p0.subtract(t0),q=w0.subtract(t0),i0=Y.x*q.y-q.x*Y.y;let W,$;if(Math.abs(i0)>1e-6){const S=1/i0;W=f0.scale(q.y).subtract(s0.scale(Y.y)).scale(S),$=s0.scale(Y.x).subtract(f0.scale(q.x)).scale(S)}else{const S=f[r];W=G(S),$=S.cross(W).normalize()}for(let S=0;S<3;S++){const C=f[r+S];let R=W.subtract(C.scale(C.dot(W)));R.lengthSq()<1e-8?R=G(C):R=R.normalize();let F=$.subtract(C.scale(C.dot($)));F.lengthSq()<1e-8?F=C.cross(R).normalize():F=F.normalize(),C.cross(R).dot(F)<0&&(F=F.scale(-1)),e.push(R),h.push(F)}}else for(let r=0;r<v.length;r++){const i=f[r],z=G(i),y=i.cross(z).normalize();e.push(z),h.push(y)}return{vertices:v,normals:f,faceNormals:s,uvs:t,tangents:e,bitangents:h}};class E{vertexId=0;nthVert=0;bc={u:0,v:0,w:0};fragPos=new M;v2f=(n,v)=>{n[this.nthVert]=v};varying=()=>Array(3);interpolate=n=>n[0]*this.bc.u+n[1]*this.bc.v+n[2]*this.bc.w;interpolateVec2=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]);return new D(v,f)};interpolateVec3=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]);return new m(v,f,t)};interpolateVec4=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]),s=this.interpolate([n[0].w,n[1].w,n[2].w]);return new M(v,f,t,s)};sample=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s].clone()};sampleDepth=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s]}}const P0=.25,D0=16,I0=.1;class b0 extends E{uniforms;vNormal=this.varying();vWorldPos=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),t=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let s=Math.pow(Math.max(n.dot(t),0),D0);s*=P0;const h=Math.max(-n.dot(this.uniforms.lightDir),0)+s+I0;return this.uniforms.lightCol.scale(h*.8)}}const M0=.25,T0=16,S0=.1;class F0 extends E{uniforms;vNormal=this.varying();vWorldPos=this.varying();vUV=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.v2f(this.vUV,n.uvs[v]),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),f=this.interpolateVec2(this.vUV),t=this.sample(this.uniforms.texture,f),e=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let h=Math.pow(Math.max(n.dot(e),0),T0);h*=M0;const a=Math.max(-n.dot(this.uniforms.lightDir),0),u=this.uniforms.lightCol.scale(a+h+S0);return t.multiplyInPlace(u)}}const L0=.25,C0=16,R0=.1;class U0 extends E{uniforms;lighting=0;vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.normalMat.multiplyDirection(n.faceNormals[v]).normalize(),t=this.uniforms.mvp.multiplyPoint(n.vertices[v]),e=this.uniforms.camPos.subtract(t.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let h=Math.pow(Math.max(f.dot(e),0),C0);h*=L0;const a=Math.max(-f.dot(this.uniforms.lightDir),0);return this.lighting=a+h+R0,this.lighting*=.8,this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>this.uniforms.lightCol.scale(this.lighting)}class V0 extends E{uniforms;vertex=()=>this.uniforms.lightSpaceMat.multiplyPoint(this.uniforms.model.vertices[this.vertexId]);fragment=()=>{}}const N0=1e-4,W0=.25,A0=16,O0=.1;class B0 extends E{uniforms;vUV=this.varying();vLightSpacePos=this.varying();vLightDirTangent=this.varying();vViewDirTangent=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=n.normals[v],t=n.tangents[v],s=n.bitangents[v],e=n.vertices[v],h=new m(t.dot(this.uniforms.mLightDir),s.dot(this.uniforms.mLightDir),f.dot(this.uniforms.mLightDir)),a=this.uniforms.mCamPos.subtract(e).normalize(),u=new m(t.dot(a),s.dot(a),f.dot(a)),d=this.uniforms.lightSpaceMat.multiplyPoint(e);return d.x=d.x*.5+.5,d.y=d.y*.5+.5,this.v2f(this.vUV,n.uvs[v]),this.v2f(this.vLightSpacePos,d),this.v2f(this.vLightDirTangent,h),this.v2f(this.vViewDirTangent,u),this.uniforms.mvp.multiplyPoint(e)};fragment=()=>{const n=this.interpolateVec2(this.vUV),v=this.interpolateVec4(this.vLightSpacePos),f=this.interpolateVec3(this.vLightDirTangent).normalize(),t=this.interpolateVec3(this.vViewDirTangent).normalize(),s=this.sampleDepth(this.uniforms.shadowMap,v),e=v.z-N0>s?0:1,h=this.sample(this.uniforms.texture,n),a=this.sample(this.uniforms.normalTexture,n),u=t.subtract(f).normalize();let d=Math.pow(Math.max(a.dot(u),0),A0);d*=W0;const l=(Math.max(-a.dot(f),0)+d)*e+O0,w=this.uniforms.lightCol.scale(l);return h.multiplyInPlace(w)}}const E0=`v -0.000581696 -0.734665 -0.623267
...
# 2492 faces
`,Y0="/js-renderer/assets/head_diffuse-Cy3ctF3i.png",q0="/js-renderer/assets/head_normal_t-2qWK4TOR.png",P=document.getElementById("canvas"),$0=document.getElementById("fps"),c0=document.getElementById("tris"),l0=document.getElementById("orthoCb"),U=document.getElementById("shadingDd"),J=document.getElementById("fileInput"),u0=P.getContext("2d");if(!u0)throw new Error("Could not get canvas context");P.width=800;P.height=600;const _=P.width/P.height,d0=new ImageData(P.width,P.height),N=new z0(d0),o0=new m0(P.width,P.height),n0=new m0(P.width,P.height),Z=new m(0,-1,1).normalize(),j0=new m(1,1,1),k=new m(0,0,-2.5);let O=1.5,L=a0(E0,!0),v0=await K.Load(Y0),y0=await K.Load(q0,!0);c0.innerText=(L.vertices.length/3).toFixed(0);let H=new m(0,0,0),B=new m(0,-Math.PI/2,0),X0=new m(1,1,1);const h0={normalMapped:new B0,textured:new F0,smooth:new b0,flat:new U0};let V;const A=new V0,Z0=o=>{B.y-=o/5},k0=()=>{N.clear(),o0.clear(1e3),n0.clear(1e3);const o=c.TRS(H,B,X0),n=o.invert(),v=o.invert().transpose(),f=c.LookTo(Z.scale(-5),Z,m.Up),t=c.Ortho(O,_),s=o.multiply(f.multiply(t)),e=n.multiplyDirection(Z).normalize(),h=n.multiplyPoint(k).xyz,a=c.LookTo(k,m.Forward,m.Up),u=l0.checked?c.Ortho(O,_):c.Perspective(60,_),d=o.multiply(a).multiply(u);U.value!=="wireframe"&&(V=h0[U.value.split("-")[0]]),!(v0.data.length&&L.uvs.length)&&(U.value.includes("textured")||U.value.includes("normalMapped"))&&(U.value="smooth",V=h0.smooth),A.uniforms={model:L,lightSpaceMat:s},V.uniforms={model:L,modelMat:o,mvp:d,normalMat:v,lightDir:Z,mLightDir:e,lightCol:j0,camPos:k,mCamPos:h,texture:v0,normalTexture:y0,lightSpaceMat:s,shadowMap:n0};const l=[];if(U.value.includes("shadows"))for(let w=0;w<L.vertices.length;w+=3){for(let g=0;g<3;g++)A.vertexId=w+g,A.nthVert=g,l[g]=A.vertex();e0(l,A,N,n0)}for(let w=0;w<L.vertices.length;w+=3){for(let g=0;g<3;g++)V.vertexId=w+g,V.nthVert=g,l[g]=V.vertex();if(U.value==="wireframe"){Q(l[0],l[1],N),Q(l[1],l[2],N),Q(l[2],l[0],N);continue}e0(l,V,N,o0)}u0.putImageData(d0,0,0)};let r0=0;const x0=()=>{const o=performance.now(),n=(o-r0)/1e3;r0=o,Z0(n),k0();const v=performance.now()-o;$0.innerText=v.toFixed(0),requestAnimationFrame(x0)};P.onmousemove=o=>{o.buttons===1?(B.y-=o.movementX/250,B.x+=o.movementY/250):(o.buttons===2||o.buttons===4)&&(H.x+=o.movementX/250,H.y-=o.movementY/250)};P.onwheel=o=>{o.preventDefault(),l0.checked?(O+=o.deltaY/100,O=Math.max(.01,O)):k.z-=o.deltaY/100};P.oncontextmenu=o=>o.preventDefault();J.onchange=async()=>{const o=J.files&&J.files[0];if(!o)return;const n=await o.text();L=a0(n,!0),v0.data=[],y0.data=[],c0.innerText=(L.vertices.length/3).toFixed(0),B.set(0,-Math.PI/2,0),H.set(0,0,0)};x0();
