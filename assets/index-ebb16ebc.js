(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))f(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const h of s.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&f(h)}).observe(document,{childList:!0,subtree:!0});function v(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function f(t){if(t.ep)return;t.ep=!0;const s=v(t);fetch(t.href,s)}})();class P{x;y;constructor(n,v){this.x=n??0,this.y=v??0}toArray(){return[this.x,this.y]}add(n){return new P(this.x+n.x,this.y+n.y)}addScalar(n){return new P(this.x+n,this.y+n)}subtract(n){return new P(this.x-n.x,this.y-n.y)}dot(n){return this.x*n.x+this.y*n.y}cross(n){return this.x*n.y-this.y*n.x}clone(){return new P(this.x,this.y)}truncate(){return new P(~~this.x,~~this.y)}scale(n){return new P(this.x*n,this.y*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this}}class r{x;y;z;static get Zero(){return new r(0,0,0)}static get One(){return new r(1,1,1)}static get Up(){return new r(0,1,0)}static get Forward(){return new r(0,0,1)}constructor(n,v,f){this.x=n??0,this.y=v??0,this.z=f??0}toArray(){return[this.x,this.y,this.z]}extend(n){return new M(this.x,this.y,this.z,n)}cross(n){return new r(this.y*n.z-this.z*n.y,this.z*n.x-this.x*n.z,this.x*n.y-this.y*n.x)}clone(){return new r(this.x,this.y,this.z)}truncate(){return new r(~~this.x,~~this.y,~~this.z)}scale(n){return new r(this.x*n,this.y*n,this.z*n)}scaleInPlace(n){return this.x*=n,this.y*=n,this.z*=n,this}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalized(){const n=1/this.length();return new r(this.x*n,this.y*n,this.z*n)}normalize(){const n=1/this.length();return this.x*=n,this.y*=n,this.z*=n,this}translate(n){return new r(this.x+n.x,this.y+n.y,this.z+n.z)}dot(n){return this.x*n.x+this.y*n.y+this.z*n.z}add(n){return new r(this.x+n.x,this.y+n.y,this.z+n.z)}addInPlace(n){return this.x+=n.x,this.y+=n.y,this.z+=n.z,this}addScalar(n){return new r(this.x+n,this.y+n,this.z+n)}subtract(n){return new r(this.x-n.x,this.y-n.y,this.z-n.z)}multiply(n){return new r(this.x*n.x,this.y*n.y,this.z*n.z)}multiplyInPlace(n){return this.x*=n.x,this.y*=n.y,this.z*=n.z,this}set(n,v,f){this.x=n,this.y=v,this.z=f}reflect(n){return this.subtract(n.scale(2*this.dot(n)))}}class M{x;y;z;w;static get Zero(){return new M(0,0,0,0)}constructor(n,v,f,t){this.x=n??0,this.y=v??0,this.z=f??0,this.w=t??0}toArray(){return[this.x,this.y,this.z,this.w]}get xyz(){return new r(this.x,this.y,this.z)}truncate(){return new M(~~this.x,~~this.y,~~this.z,~~this.w)}divideByW(){return new r(this.x/this.w,this.y/this.w,this.z/this.w)}}class m{m;constructor(){this.m=new Float32Array(16)}static Identity(){const n=new m;return n.m[0]=1,n.m[5]=1,n.m[10]=1,n.m[15]=1,n}static Scale(n){const v=m.Identity();return v.m[0]=n.x,v.m[5]=n.y,v.m[10]=n.z,v}static RotateX(n){const v=m.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[5]=f,v.m[6]=t,v.m[9]=-t,v.m[10]=f,v}static RotateY(n){const v=m.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[2]=-t,v.m[8]=t,v.m[10]=f,v}static RotateZ(n){const v=m.Identity(),f=Math.cos(n),t=Math.sin(n);return v.m[0]=f,v.m[1]=t,v.m[4]=-t,v.m[5]=f,v}static RotateYXZ(n){return m.RotateZ(n.z).multiply(m.RotateX(n.x)).multiply(m.RotateY(n.y))}static Translate(n){const v=m.Identity();return v.m[12]=n.x,v.m[13]=n.y,v.m[14]=n.z,v}static TRS(n,v,f){return m.Scale(f).multiply(m.RotateYXZ(v)).multiply(m.Translate(n))}static LookTo(n,v,f){const t=v.normalize(),s=f.cross(t).normalize(),h=t.cross(s).normalize(),i=m.Identity();return i.m[0]=s.x,i.m[1]=h.x,i.m[2]=t.x,i.m[4]=s.y,i.m[5]=h.y,i.m[6]=t.y,i.m[8]=s.z,i.m[9]=h.z,i.m[10]=t.z,i.m[12]=-s.dot(n),i.m[13]=-h.dot(n),i.m[14]=-t.dot(n),i}static LookAt(n,v,f){const t=v.subtract(n).normalize(),s=f.cross(t).normalize(),h=t.cross(s).normalize(),i=m.Identity();return i.m[0]=s.x,i.m[1]=h.x,i.m[2]=t.x,i.m[4]=s.y,i.m[5]=h.y,i.m[6]=t.y,i.m[8]=s.z,i.m[9]=h.z,i.m[10]=t.z,i.m[12]=-s.dot(n),i.m[13]=-h.dot(n),i.m[14]=-t.dot(n),i}static Ortho(n,v,f=.1,t=1e3){const s=m.Identity();return s.m[0]=1/(n*v),s.m[5]=1/n,s.m[10]=1/(t-f),s.m[14]=-f/(t-f),s}static Perspective(n,v,f=.1,t=1e3){const s=m.Identity(),h=n*(Math.PI/180),i=Math.tan(h/2);return s.m[0]=1/(v*i),s.m[5]=1/i,s.m[10]=t/(t-f),s.m[11]=1,s.m[14]=-f*(t/(t-f)),s.m[15]=0,s}toArray(){return this.m}multiplyVector4(n){const v=new M;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12],v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13],v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14],v.w=this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15],v}multiplyPoint(n){const v=1/(this.m[3]*n.x+this.m[7]*n.y+this.m[11]*n.z+this.m[15]),f=new M;return f.x=(this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z+this.m[12])*v,f.y=(this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z+this.m[13])*v,f.z=(this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z+this.m[14])*v,f.w=v,f}multiplyDirection(n){const v=new r;return v.x=this.m[0]*n.x+this.m[4]*n.y+this.m[8]*n.z,v.y=this.m[1]*n.x+this.m[5]*n.y+this.m[9]*n.z,v.z=this.m[2]*n.x+this.m[6]*n.y+this.m[10]*n.z,v}multiply(n){const v=new m;return v.m[0]=this.m[0]*n.m[0]+this.m[1]*n.m[4]+this.m[2]*n.m[8]+this.m[3]*n.m[12],v.m[1]=this.m[0]*n.m[1]+this.m[1]*n.m[5]+this.m[2]*n.m[9]+this.m[3]*n.m[13],v.m[2]=this.m[0]*n.m[2]+this.m[1]*n.m[6]+this.m[2]*n.m[10]+this.m[3]*n.m[14],v.m[3]=this.m[0]*n.m[3]+this.m[1]*n.m[7]+this.m[2]*n.m[11]+this.m[3]*n.m[15],v.m[4]=this.m[4]*n.m[0]+this.m[5]*n.m[4]+this.m[6]*n.m[8]+this.m[7]*n.m[12],v.m[5]=this.m[4]*n.m[1]+this.m[5]*n.m[5]+this.m[6]*n.m[9]+this.m[7]*n.m[13],v.m[6]=this.m[4]*n.m[2]+this.m[5]*n.m[6]+this.m[6]*n.m[10]+this.m[7]*n.m[14],v.m[7]=this.m[4]*n.m[3]+this.m[5]*n.m[7]+this.m[6]*n.m[11]+this.m[7]*n.m[15],v.m[8]=this.m[8]*n.m[0]+this.m[9]*n.m[4]+this.m[10]*n.m[8]+this.m[11]*n.m[12],v.m[9]=this.m[8]*n.m[1]+this.m[9]*n.m[5]+this.m[10]*n.m[9]+this.m[11]*n.m[13],v.m[10]=this.m[8]*n.m[2]+this.m[9]*n.m[6]+this.m[10]*n.m[10]+this.m[11]*n.m[14],v.m[11]=this.m[8]*n.m[3]+this.m[9]*n.m[7]+this.m[10]*n.m[11]+this.m[11]*n.m[15],v.m[12]=this.m[12]*n.m[0]+this.m[13]*n.m[4]+this.m[14]*n.m[8]+this.m[15]*n.m[12],v.m[13]=this.m[12]*n.m[1]+this.m[13]*n.m[5]+this.m[14]*n.m[9]+this.m[15]*n.m[13],v.m[14]=this.m[12]*n.m[2]+this.m[13]*n.m[6]+this.m[14]*n.m[10]+this.m[15]*n.m[14],v.m[15]=this.m[12]*n.m[3]+this.m[13]*n.m[7]+this.m[14]*n.m[11]+this.m[15]*n.m[15],v}transpose(){const n=new m;return n.m[0]=this.m[0],n.m[1]=this.m[4],n.m[2]=this.m[8],n.m[3]=this.m[12],n.m[4]=this.m[1],n.m[5]=this.m[5],n.m[6]=this.m[9],n.m[7]=this.m[13],n.m[8]=this.m[2],n.m[9]=this.m[6],n.m[10]=this.m[10],n.m[11]=this.m[14],n.m[12]=this.m[3],n.m[13]=this.m[7],n.m[14]=this.m[11],n.m[15]=this.m[15],n}invert(){let n=this.m,v=new m;v.m[0]=n[5]*n[10]*n[15]-n[5]*n[11]*n[14]-n[9]*n[6]*n[15]+n[9]*n[7]*n[14]+n[13]*n[6]*n[11]-n[13]*n[7]*n[10],v.m[4]=-n[4]*n[10]*n[15]+n[4]*n[11]*n[14]+n[8]*n[6]*n[15]-n[8]*n[7]*n[14]-n[12]*n[6]*n[11]+n[12]*n[7]*n[10],v.m[8]=n[4]*n[9]*n[15]-n[4]*n[11]*n[13]-n[8]*n[5]*n[15]+n[8]*n[7]*n[13]+n[12]*n[5]*n[11]-n[12]*n[7]*n[9],v.m[12]=-n[4]*n[9]*n[14]+n[4]*n[10]*n[13]+n[8]*n[5]*n[14]-n[8]*n[6]*n[13]-n[12]*n[5]*n[10]+n[12]*n[6]*n[9],v.m[1]=-n[1]*n[10]*n[15]+n[1]*n[11]*n[14]+n[9]*n[2]*n[15]-n[9]*n[3]*n[14]-n[13]*n[2]*n[11]+n[13]*n[3]*n[10],v.m[5]=n[0]*n[10]*n[15]-n[0]*n[11]*n[14]-n[8]*n[2]*n[15]+n[8]*n[3]*n[14]+n[12]*n[2]*n[11]-n[12]*n[3]*n[10],v.m[9]=-n[0]*n[9]*n[15]+n[0]*n[11]*n[13]+n[8]*n[1]*n[15]-n[8]*n[3]*n[13]-n[12]*n[1]*n[11]+n[12]*n[3]*n[9],v.m[13]=n[0]*n[9]*n[14]-n[0]*n[10]*n[13]-n[8]*n[1]*n[14]+n[8]*n[2]*n[13]+n[12]*n[1]*n[10]-n[12]*n[2]*n[9],v.m[2]=n[1]*n[6]*n[15]-n[1]*n[7]*n[14]-n[5]*n[2]*n[15]+n[5]*n[3]*n[14]+n[13]*n[2]*n[7]-n[13]*n[3]*n[6],v.m[6]=-n[0]*n[6]*n[15]+n[0]*n[7]*n[14]+n[4]*n[2]*n[15]-n[4]*n[3]*n[14]-n[12]*n[2]*n[7]+n[12]*n[3]*n[6],v.m[10]=n[0]*n[5]*n[15]-n[0]*n[7]*n[13]-n[4]*n[1]*n[15]+n[4]*n[3]*n[13]+n[12]*n[1]*n[7]-n[12]*n[3]*n[5],v.m[14]=-n[0]*n[5]*n[14]+n[0]*n[6]*n[13]+n[4]*n[1]*n[14]-n[4]*n[2]*n[13]-n[12]*n[1]*n[6]+n[12]*n[2]*n[5],v.m[3]=-n[1]*n[6]*n[11]+n[1]*n[7]*n[10]+n[5]*n[2]*n[11]-n[5]*n[3]*n[10]-n[9]*n[2]*n[7]+n[9]*n[3]*n[6],v.m[7]=n[0]*n[6]*n[11]-n[0]*n[7]*n[10]-n[4]*n[2]*n[11]+n[4]*n[3]*n[10]+n[8]*n[2]*n[7]-n[8]*n[3]*n[6],v.m[11]=-n[0]*n[5]*n[11]+n[0]*n[7]*n[9]+n[4]*n[1]*n[11]-n[4]*n[3]*n[9]-n[8]*n[1]*n[7]+n[8]*n[3]*n[5],v.m[15]=n[0]*n[5]*n[10]-n[0]*n[6]*n[9]-n[4]*n[1]*n[10]+n[4]*n[2]*n[9]+n[8]*n[1]*n[6]-n[8]*n[2]*n[5];let f=n[0]*v.m[0]+n[1]*v.m[4]+n[2]*v.m[8]+n[3]*v.m[12];if(f===0)return new m;const t=1/f;return v.m[0]*=t,v.m[1]*=t,v.m[2]*=t,v.m[3]*=t,v.m[4]*=t,v.m[5]*=t,v.m[6]*=t,v.m[7]*=t,v.m[8]*=t,v.m[9]*=t,v.m[10]*=t,v.m[11]*=t,v.m[12]*=t,v.m[13]*=t,v.m[14]*=t,v.m[15]*=t,v}print(){console.log(this.m[0].toFixed(2),this.m[4].toFixed(2),this.m[8].toFixed(2),this.m[12].toFixed(2)),console.log(this.m[1].toFixed(2),this.m[5].toFixed(2),this.m[9].toFixed(2),this.m[13].toFixed(2)),console.log(this.m[2].toFixed(2),this.m[6].toFixed(2),this.m[10].toFixed(2),this.m[14].toFixed(2)),console.log(this.m[3].toFixed(2),this.m[7].toFixed(2),this.m[11].toFixed(2),this.m[15].toFixed(2))}}const i0=new r(1,1,1),V=(o,n,v)=>{if(o.z<-1||n.z<-1||o.z>1||n.z>1||o.x<-1&&n.x<-1||o.x>1&&n.x>1||o.y<-1&&n.y<-1||o.y>1&&n.y>1)return;o=v.viewportTransform(o),n=v.viewportTransform(n);let f=o.truncate(),t=n.truncate();const s=Math.abs(t.x-f.x),h=Math.abs(t.y-f.y),i=f.x<t.x?1:-1,p=f.y<t.y?1:-1;let d=s-h;for(;f.x>=0&&f.x<v.width&&f.y>=0&&f.y<v.height&&v.setPixel(f.x,f.y,i0),!(f.x===t.x&&f.y===t.y);){const w=2*d;w>-h&&(d-=h,f.x+=i),w<s&&(d+=s,f.y+=p)}},A=(o,n,v)=>(v.x-o.x)*(n.y-o.y)-(v.y-o.y)*(n.x-o.x),y=new M,x={u:0,v:0,w:0},U={u:0,v:0,w:0},k=(o,n,v,f)=>{const t=v.viewportTransform(o[0]),s=v.viewportTransform(o[1]),h=v.viewportTransform(o[2]),i=1/A(h,s,t);if(i<=0||t.z<0||s.z<0||h.z<0||t.z>1||s.z>1||h.z>1||t.x<0&&s.x<0&&h.x<0||t.x>v.width&&s.x>v.width&&h.x>v.width||t.y<0&&s.y<0&&h.y<0||t.y>v.height&&s.y>v.height&&h.y>v.height)return;let p=~~Math.max(0,Math.min(t.x,s.x,h.x)),d=~~Math.max(0,Math.min(t.y,s.y,h.y)),w=~~Math.min(v.width,Math.max(t.x,s.x,h.x)),D=~~Math.min(v.height,Math.max(t.y,s.y,h.y));const u=new M(p,d);let l=A(h,s,u)*i,a=A(t,h,u)*i,c=A(s,t,u)*i;const e=new P(s.y-h.y,h.x-s.x).scaleInPlace(i),I=new P(h.y-t.y,t.x-h.x).scaleInPlace(i),g=new P(t.y-s.y,s.x-t.x).scaleInPlace(i);for(y.y=d;y.y<=D;y.y++){for(x.u=l,x.v=a,x.w=c,y.x=p;y.x<=w;y.x++){if(x.u>=0&&x.v>=0&&x.w>=0){y.z=t.z*x.u+s.z*x.v+h.z*x.w;const Z=y.x+y.y*v.width;if(y.z<f.data[Z]){f.data[Z]=y.z,y.w=1/(t.w*x.u+s.w*x.v+h.w*x.w),U.u=x.u*y.w*t.w,U.v=x.v*y.w*s.w,U.w=x.w*y.w*h.w,n.bc=U,n.fragPos=y;const q=n.fragment();q&&v.setPixel(y.x,y.y,q)}}x.u+=e.x,x.v+=I.x,x.w+=g.x}l+=e.y,a+=I.y,c+=g.y}};class G{data;width;height;constructor(n,v){this.data=new Float32Array(n*v),this.width=n,this.height=v}clear(n){this.data.fill(n)}}class E{data;width;height;constructor(n,v,f){this.data=n,this.width=v,this.height=f}static Load=async n=>{const v=new Image;v.src=n,await v.decode();const t=new OffscreenCanvas(v.width,v.height).getContext("2d");if(!t)throw new Error("Could not get texture context");t.drawImage(v,0,0);const s=t.getImageData(0,0,v.width,v.height),h=[];for(let i=0;i<s.data.length;i+=4)h.push(new r(s.data[i]/255,s.data[i+1]/255,s.data[i+2]/255));return new E(h,v.width,v.height)}}class e0{width;height;totalPixels;data;constructor(n){this.width=n.width,this.height=n.height,this.totalPixels=this.width*this.height,this.data=n.data}setPixel=(n,v,f)=>{const t=(n+v*this.width)*4;this.data[t+0]=f.x*255,this.data[t+1]=f.y*255,this.data[t+2]=f.z*255};clear=()=>{this.data.fill(0);for(let n=3;n<this.totalPixels*4;n+=4)this.data[n]=255};viewportTransform=n=>{const v=(n.x+1)*(this.width*.5),f=(-n.y+1)*(this.height*.5);return new M(v,f,n.z,n.w)}}const J=(o,n=!1)=>{const v=[];let f=[];const t=[],s=[],h=[],i=[],p=[],d=[],w=[],D=[],u=o.split(`
`);for(let c=0;c<u.length;c++){const e=u[c].trim().split(/\s+/),I=e.length===5;e[0]=="v"?h.push(new r(+e[1],+e[2],+e[3])):e[0]=="vt"?i.push(new P(+e[1],+e[2])):e[0]=="vn"?p.push(new r(+e[1],+e[2],+e[3])):e[0]=="f"&&(I?(d.push(+e[1].split("/")[0]-1,+e[2].split("/")[0]-1,+e[3].split("/")[0]-1),d.push(+e[1].split("/")[0]-1,+e[3].split("/")[0]-1,+e[4].split("/")[0]-1),w.push(+e[1].split("/")[1]-1,+e[2].split("/")[1]-1,+e[3].split("/")[1]-1),w.push(+e[1].split("/")[1]-1,+e[3].split("/")[1]-1,+e[4].split("/")[1]-1),D.push(+e[1].split("/")[2]-1,+e[2].split("/")[2]-1,+e[3].split("/")[2]-1),D.push(+e[1].split("/")[2]-1,+e[3].split("/")[2]-1,+e[4].split("/")[2]-1)):(d.push(+e[1].split("/")[0]-1,+e[2].split("/")[0]-1,+e[3].split("/")[0]-1),w.push(+e[1].split("/")[1]-1,+e[2].split("/")[1]-1,+e[3].split("/")[1]-1),D.push(+e[1].split("/")[2]-1,+e[2].split("/")[2]-1,+e[3].split("/")[2]-1)))}const l=new r(0,0,0),a=new r(0,0,0);for(let c=0;c<d.length;c++){const e=h[d[c]],I=p[D[c]],g=i[w[c]];v.push(e),I&&f.push(I),g&&t.push(g),e.x>l.x&&(l.x=e.x),e.y>l.y&&(l.y=e.y),e.z>l.z&&(l.z=e.z),e.x<a.x&&(a.x=e.x),e.y<a.y&&(a.y=e.y),e.z<a.z&&(a.z=e.z)}for(let c=0;c<v.length;c+=3){const e=v[c+1].subtract(v[c]),I=v[c+2].subtract(v[c]),g=e.cross(I).normalize();s.push(g,g,g)}if(n){const c=l.subtract(a),e=2/Math.max(c.x,c.y,c.z),I=l.add(a).scale(.5);for(let g=0;g<v.length;g++)v[g]=v[g].subtract(I).scale(e)}return f.length||(f=s),{vertices:v,normals:f,faceNormals:s,uvs:t}};class R{vertexId=0;nthVert=0;bc={u:0,v:0,w:0};fragPos=new M;v2f=(n,v)=>{n[this.nthVert]=v};varying=()=>Array(3);interpolate=n=>n[0]*this.bc.u+n[1]*this.bc.v+n[2]*this.bc.w;interpolateVec2=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]);return new P(v,f)};interpolateVec3=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]);return new r(v,f,t)};interpolateVec4=n=>{const v=this.interpolate([n[0].x,n[1].x,n[2].x]),f=this.interpolate([n[0].y,n[1].y,n[2].y]),t=this.interpolate([n[0].z,n[1].z,n[2].z]),s=this.interpolate([n[0].w,n[1].w,n[2].w]);return new M(v,f,t,s)};sample=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s].clone()};sampleNormal=(n,v)=>{const f=this.sample(n,v);return f.x=f.x*2-1,f.y=f.y*2-1,f.z=f.z*2-1,f.normalize()};sampleDepth=(n,v)=>{const f=~~(v.x*n.width),t=~~((1-v.y)*n.height),s=f+t*n.width;return n.data[s]}}const o0=.25,h0=16,r0=.1;class m0 extends R{uniforms;vNormal=this.varying();vWorldPos=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),t=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let s=Math.pow(Math.max(n.dot(t),0),h0);s*=o0;const i=Math.max(-n.dot(this.uniforms.lightDir),0)+s+r0;return this.uniforms.lightCol.scale(i*.8)}}const a0=.25,c0=16,l0=.1;class u0 extends R{uniforms;vNormal=this.varying();vWorldPos=this.varying();vUV=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.modelMat.multiplyPoint(n.vertices[v]),t=this.uniforms.normalMat.multiplyDirection(n.normals[v]).normalize();return this.v2f(this.vNormal,t),this.v2f(this.vWorldPos,f),this.v2f(this.vUV,n.uvs[v]),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vNormal).normalize(),v=this.interpolateVec4(this.vWorldPos),f=this.interpolateVec2(this.vUV),t=this.sample(this.uniforms.texture,f),h=this.uniforms.camPos.subtract(v.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let i=Math.pow(Math.max(n.dot(h),0),c0);i*=a0;const p=Math.max(-n.dot(this.uniforms.lightDir),0),d=this.uniforms.lightCol.scale(p+i+l0);return t.multiplyInPlace(d)}}const d0=.25,y0=16,x0=.1;class p0 extends R{uniforms;lighting=0;vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.normalMat.multiplyDirection(n.faceNormals[v]).normalize(),t=this.uniforms.mvp.multiplyPoint(n.vertices[v]),h=this.uniforms.camPos.subtract(t.xyz).normalize().subtract(this.uniforms.lightDir).normalize();let i=Math.pow(Math.max(f.dot(h),0),y0);i*=d0;const p=Math.max(-f.dot(this.uniforms.lightDir),0);return this.lighting=p+i+x0,this.lighting*=.8,this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>this.uniforms.lightCol.scale(this.lighting)}class w0 extends R{uniforms;vertex=()=>this.uniforms.lightSpaceMat.multiplyPoint(this.uniforms.model.vertices[this.vertexId]);fragment=()=>{}}const g0=1e-4,z0=.25,P0=16,I0=.1;class M0 extends R{uniforms;vUV=this.varying();vLightSpacePos=this.varying();vModelPos=this.varying();vertex=()=>{const n=this.uniforms.model,v=this.vertexId,f=this.uniforms.lightSpaceMat.multiplyPoint(n.vertices[v]);return f.x=f.x*.5+.5,f.y=f.y*.5+.5,this.v2f(this.vUV,n.uvs[v]),this.v2f(this.vLightSpacePos,f),this.v2f(this.vModelPos,n.vertices[v]),this.uniforms.mvp.multiplyPoint(n.vertices[v])};fragment=()=>{const n=this.interpolateVec3(this.vModelPos),v=this.interpolateVec2(this.vUV),f=this.interpolateVec4(this.vLightSpacePos),t=this.sampleDepth(this.uniforms.shadowMap,f),s=f.z-g0>t?0:1,h=this.sample(this.uniforms.texture,v),i=this.sampleNormal(this.uniforms.normalTexture,v),d=this.uniforms.mCamPos.subtract(n).normalize().subtract(this.uniforms.mLightDir).normalize();let w=Math.pow(Math.max(i.dot(d),0),P0);w*=z0;const u=(Math.max(-i.dot(this.uniforms.mLightDir),0)+w)*s+I0,l=this.uniforms.lightCol.scale(u);return h.multiplyInPlace(l)}}const D0=`v -0.000581696 -0.734665 -0.623267
...
# 2492 faces
`,S0="/js-renderer/assets/head_diffuse-9e424815.png",F0="/js-renderer/assets/head_normal_w-ec45eef9.png",z=document.getElementById("canvas"),T0=document.getElementById("fps"),_=document.getElementById("tris"),n0=document.getElementById("orthoCb"),F=document.getElementById("shadingDd"),Y=document.getElementById("fileInput"),v0=z.getContext("2d");if(!v0)throw new Error("Could not get canvas context");z.width=800;z.height=600;const $=z.width/z.height,t0=new ImageData(z.width,z.height),b=new e0(t0),H=new G(z.width,z.height),X=new G(z.width,z.height),W=new r(0,-1,1).normalize(),b0=new r(1,1,1),O=new r(0,0,-2.5);let C=1.5,S=J(D0,!0),j=await E.Load(S0),f0=await E.Load(F0);_.innerText=(S.vertices.length/3).toFixed(0);let B=new r(0,0,0),N=new r(0,-Math.PI/2,0),L0=new r(1,1,1);const K={normalMapped:new M0,textured:new u0,smooth:new m0,flat:new p0};let T;const L=new w0,C0=o=>{N.y-=o/5},N0=()=>{b.clear(),H.clear(1e3),X.clear(1e3);const o=m.TRS(B,N,L0),n=o.invert(),v=o.invert().transpose(),f=m.LookTo(W.scale(-5),W,r.Up),t=m.Ortho(C,$),s=o.multiply(f.multiply(t)),h=n.multiplyDirection(W).normalize(),i=n.multiplyPoint(O).xyz,p=m.LookTo(O,r.Forward,r.Up),d=n0.checked?m.Ortho(C,$):m.Perspective(60,$),w=o.multiply(p).multiply(d);F.value!=="wireframe"&&(T=K[F.value.split("-")[0]]),!(j.data.length&&S.uvs.length)&&(F.value.includes("textured")||F.value.includes("normalMapped"))&&(F.value="smooth",T=K.smooth),L.uniforms={model:S,lightSpaceMat:s},T.uniforms={model:S,modelMat:o,mvp:w,normalMat:v,lightDir:W,mLightDir:h,lightCol:b0,camPos:O,mCamPos:i,texture:j,normalTexture:f0,lightSpaceMat:s,shadowMap:X};const u=[];if(F.value.includes("shadows"))for(let l=0;l<S.vertices.length;l+=3){for(let a=0;a<3;a++)L.vertexId=l+a,L.nthVert=a,u[a]=L.vertex();k(u,L,b,X)}for(let l=0;l<S.vertices.length;l+=3){for(let a=0;a<3;a++)T.vertexId=l+a,T.nthVert=a,u[a]=T.vertex();if(F.value==="wireframe"){V(u[0],u[1],b),V(u[1],u[2],b),V(u[2],u[0],b);continue}k(u,T,b,H)}v0.putImageData(t0,0,0)};let Q=0;const s0=()=>{const o=performance.now(),n=(o-Q)/1e3;Q=o,C0(n),N0();const v=performance.now()-o;T0.innerText=v.toFixed(0),requestAnimationFrame(s0)};z.onmousemove=o=>{o.buttons===1?(N.y-=o.movementX/250,N.x+=o.movementY/250):(o.buttons===2||o.buttons===4)&&(B.x+=o.movementX/250,B.y-=o.movementY/250)};z.onwheel=o=>{o.preventDefault(),n0.checked?(C+=o.deltaY/100,C=Math.max(.01,C)):O.z-=o.deltaY/100};z.oncontextmenu=o=>o.preventDefault();Y.onchange=async()=>{const o=Y.files&&Y.files[0];if(!o)return;const n=await o.text();S=J(n,!0),j.data=[],f0.data=[],_.innerText=(S.vertices.length/3).toFixed(0),N.set(0,-Math.PI/2,0),B.set(0,0,0)};s0();
